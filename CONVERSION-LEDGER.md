...
**Current strict completion: 2.93% of all tracked upstream modules (139/4740).**
Production-only strict completion: **11.31%** (139/1229 production modules).
...
|---|---:|---:|---:|---:|---:|
| All tracked modules | 139 | 21 | 4580 | 2.93% | 46,787/1,910,919 done LOC |
| Production modules | 139 | 21 | 1069 | 11.31% | 46,787/993,168 done LOC |

Inventory source: `/run/media/mustbearnold/Projects/Research/hermes-agent-repo` at `2026-08-31T12:46:34`.
...
|---|---|---:|---|
| `agent.auxiliary_client` | P2 | 11,285 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
...
| `providers.base` | P2 | 296 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `tools.credential_files` | P2 | 603 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `tools.delegation_output_schema` | P2 | 151 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `tools.threat_patterns` | P2 | 289 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `tools.todo_tool` | P2 | 450 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `tools.tool_backend_helpers` | P2 | 431 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
...
|---:|---|---|---:|---|
| 1 | `run_agent` | P2 | 9,338 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 2 | `agent.context_compressor` | P2 | 8,692 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 3 | `agent.conversation_loop` | P2 | 8,676 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 4 | `tools.mcp_tool` | P2 | 8,672 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 5 | `tools.browser_tool` | P2 | 6,329 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 6 | `tools.approval` | P2 | 5,802 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 7 | `agent.chat_completion_helpers` | P2 | 5,474 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 8 | `agent.conversation_compression` | P2 | 5,277 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 9 | `tools.delegate_tool` | P2 | 5,071 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 10 | `agent.agent_runtime_helpers` | P2 | 4,963 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 11 | `tools.skills_hub` | P2 | 4,956 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 12 | `tools.tts_tool` | P2 | 4,552 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 13 | `tools.terminal_tool` | P2 | 4,213 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 14 | `tools.computer_use.cua_backend` | P2 | 4,137 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 15 | `agent.model_metadata` | P2 | 3,931 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 16 | `tools.file_operations` | P2 | 3,578 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 17 | `tools.transcription_tools` | P2 | 3,419 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 18 | `tools.process_registry` | P2 | 3,371 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 19 | `optional-skills.migration.openclaw-migration.scripts.openclaw_to_hermes` | P2 | 3,286 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
| 20 | `agent.agent_init` | P2 | 3,132 | TDD against upstream module/tests, implement, review, build/test, update ledger, commit. |
...
| `acp_adapter.entry` | production | P5 | 282 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `acp_adapter.permissions` | production | P5 | 190 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `acp_adapter.server` | production | P5 | 2,640 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `acp_adapter.session` | production | P5 | 695 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `acp_adapter.tools` | production | P5 | 1,362 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.acp_openai_bridge` | production | P2 | 287 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.agent_init` | production | P2 | 3,132 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.agent_runtime_helpers` | production | P2 | 4,963 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.anthropic_adapter` | production | P2 | 1,217 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.anthropic_credentials` | production | P2 | 1,124 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.anthropic_endpoints` | production | P2 | 258 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.anthropic_message_convert` | production | P2 | 1,225 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.auxiliary_client` | production | P2 | 11,285 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `agent.background_review` | production | P2 | 1,829 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.bedrock_adapter` | production | P2 | 1,948 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.codex_responses_adapter` | production | P2 | 1,896 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.codex_runtime` | production | P2 | 1,858 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.coding_context` | production | P2 | 932 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.command_token_source` | production | P2 | 190 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.compaction_display` | production | P2 | 47 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.context_breakdown` | production | P2 | 372 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.context_compressor` | production | P2 | 8,692 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.context_references` | production | P2 | 720 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.conversation_compression` | production | P2 | 5,277 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.conversation_loop` | production | P2 | 8,676 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.copilot_acp_client` | production | P2 | 678 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.credential_persistence` | production | P2 | 183 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.credential_pool` | production | P2 | 3,566 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `agent.credential_sources` | production | P2 | 451 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.credits_tracker` | production | P2 | 860 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.curator` | production | P2 | 2,041 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.curator_backup` | production | P2 | 758 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.deadline` | production | P2 | 650 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.display` | production | P2 | 1,589 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.empty_response_guard` | production | P2 | 272 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.error_classifier` | production | P2 | 2,244 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.error_surface` | production | P2 | 258 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.errors` | production | P2 | 13 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `agent.estop` | production | P2 | 174 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.file_safety` | production | P2 | 758 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `agent.gemini_native_adapter` | production | P2 | 1,274 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.image_gen_provider` | production | P2 | 399 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.image_gen_registry` | production | P2 | 196 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.image_routing` | production | P2 | 929 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.insights` | production | P2 | 1,212 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.interrupt_compat` | production | P2 | 64 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `agent.iteration_budget` | production | P2 | 62 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.learn_prompt` | production | P2 | 237 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.lmstudio_reasoning` | production | P2 | 60 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.lsp.client` | production | P2 | 1,066 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.message_metadata` | production | P2 | 41 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.message_sanitization` | production | P2 | 1,049 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.moa_loop` | production | P2 | 2,459 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.moa_trace` | production | P2 | 182 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.model_metadata` | production | P2 | 3,931 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.models_dev` | production | P2 | 1,550 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.monitoring.__init__` | production | P2 | 29 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.monitoring.gateway_health_export` | production | P2 | 643 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `agent.native_compaction` | production | P2 | 509 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.pet.generate.orchestrate` | production | P2 | 387 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.pet.render` | production | P2 | 698 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.plan_prompt` | production | P2 | 103 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.plugin_llm` | production | P2 | 1,217 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.plugin_stream_hooks` | production | P2 | 176 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.portal_tags` | production | P2 | 144 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `agent.process_bootstrap` | production | P2 | 462 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.prompt_builder` | production | P2 | 2,452 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.prompt_cache_boundary` | production | P2 | 95 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.prompt_cache_scope` | production | P2 | 125 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.prompt_caching` | production | P2 | 633 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.provider_projection` | production | P2 | 70 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.redact` | production | P1 | 1,427 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `agent.relay_llm` | production | P2 | 1,357 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.relay_runtime` | production | P2 | 2,073 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.relay_tools` | production | P2 | 137 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.repetition_guard` | production | P2 | 95 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.review_engine` | production | P2 | 299 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.secret_scope` | production | P2 | 310 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.secret_sources.registry` | production | P2 | 564 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.side_question` | production | P2 | 329 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.skill_commands` | production | P2 | 904 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.skill_utils` | production | P2 | 1,260 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.ssl_guard` | production | P2 | 101 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.subagent_lifecycle` | production | P2 | 542 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.subdirectory_hints` | production | P2 | 342 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.tool_dispatch_helpers` | production | P2 | 859 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.tool_executor` | production | P2 | 2,931 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.tool_guardrails` | production | P2 | 854 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.tool_result_classification` | production | P2 | 40 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `agent.trace_upload` | production | P2 | 404 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.trajectory` | production | P2 | 56 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `agent.transcript_repair` | production | P2 | 112 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.transcription_provider` | production | P2 | 198 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.transcription_registry` | production | P2 | 163 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.transports.chat_completions` | production | P2 | 1,063 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.transports.codex` | production | P2 | 983 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.transports.hermes_tools_mcp_server` | production | P2 | 289 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.tts_registry` | production | P2 | 173 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.turn_context` | production | P2 | 1,567 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.turn_finalizer` | production | P2 | 851 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.turn_retry_state` | production | P2 | 93 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.usage_pricing` | production | P2 | 1,600 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `agent.verify.__init__` | production | P2 | 38 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.verify.runner` | production | P2 | 279 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.video_gen_provider` | production | P2 | 604 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.video_gen_registry` | production | P2 | 184 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.web_search_provider` | production | P2 | 227 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `agent.web_search_registry` | production | P2 | 411 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `apps.desktop.scripts.perf.gateway_attach_bench` | production | P2 | 261 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `batch_runner` | production | P2 | 1,380 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cli` | production | P3 | 22,119 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.__init__` | production | P4 | 44 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.blueprint_catalog` | production | P4 | 799 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.executions` | production | P4 | 286 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.incidents` | production | P4 | 302 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.jobs` | production | P4 | 4,433 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.lifecycle_guard` | production | P4 | 1,271 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.monitor` | production | P4 | 213 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.notepad` | production | P4 | 189 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.scheduler` | production | P4 | 8,139 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `cron.scheduler_provider` | production | P4 | 753 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `cron.suggestions` | production | P4 | 271 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.browser_use.orchestrate` | production | P2 | 129 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.browser_use.orchestrate_cloud` | production | P2 | 184 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.browser_use.report` | production | P2 | 70 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.browser_use.single_run` | production | P2 | 198 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.fixtures` | production | P2 | 79 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.policies` | production | P2 | 54 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.report` | production | P2 | 43 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.runner` | production | P2 | 356 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.scripts.build_html_report` | production | P2 | 184 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.scripts.codex_arm` | production | P2 | 211 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.scripts.reconstruct_lineage` | production | P2 | 88 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.scripts.replay_lineage` | production | P2 | 81 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.compaction.test_region_scoping` | oracle/test | oracle | 98 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `evals.readtool.fixtures` | production | P2 | 227 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.readtool.report` | production | P2 | 118 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.readtool.runner` | production | P2 | 206 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.readtool.tasks` | production | P2 | 178 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.session_search_schema.fixtures` | production | P2 | 126 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.session_search_schema.report` | production | P2 | 78 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.session_search_schema.runner` | production | P2 | 286 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `evals.session_search_schema.tasks` | production | P2 | 65 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.authz_mixin` | production | P4 | 897 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.browser_control_artifacts` | production | P4 | 531 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.browser_control_broker` | production | P4 | 1,067 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.cgroup_cleanup` | production | P4 | 81 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `gateway.code_skew` | production | P4 | 64 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `gateway.config` | production | P4 | 2,892 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.control_socket` | production | P4 | 560 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.delivery_ledger` | production | P4 | 562 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.disk_status` | production | P4 | 117 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.display_config` | production | P4 | 316 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.drain_control` | production | P4 | 370 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.hooks` | production | P4 | 229 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.kanban_watchers` | production | P4 | 1,849 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.lifecycle_ledger` | production | P4 | 332 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.media_policy` | production | P4 | 88 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.media_repair` | production | P4 | 213 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.memory_status` | production | P4 | 203 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.mirror` | production | P4 | 225 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.platforms.msgraph_webhook` | production | P4 | 457 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.platforms.webhook` | production | P4 | 1,483 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.platforms.weixin` | production | P4 | 2,453 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.platforms.whatsapp_cloud` | production | P4 | 2,113 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.platforms.yuanbao` | production | P4 | 5,325 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.relay.command_manifest` | production | P4 | 150 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.relay.descriptor` | production | P4 | 193 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.relay.media` | production | P4 | 214 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.relay.ws_transport` | production | P4 | 1,129 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.restart` | production | P4 | 240 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.restart_loop_guard` | production | P4 | 214 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.rich_sent_store` | production | P4 | 83 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `gateway.run` | production | P4 | 32,612 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.scale_to_zero` | production | P4 | 245 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.shutdown_watchdog` | production | P4 | 620 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.slash_commands` | production | P4 | 6,382 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `gateway.status` | production | P4 | 2,500 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.stream_consumer` | production | P4 | 3,533 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `gateway.turn_context` | production | P4 | 145 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.__init__` | production | P3 | 92 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `hermes_cli._early_recovery` | production | P3 | 666 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli._install_repair` | production | P3 | 692 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli._parser` | production | P3 | 609 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli._scan_venv_blockers` | production | P3 | 300 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli._startup_fast` | production | P3 | 275 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli._subprocess_compat` | production | P3 | 576 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.active_sessions` | production | P3 | 722 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.agent_plugins` | production | P3 | 571 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.approval_mode` | production | P3 | 88 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.approval_transport` | production | P3 | 219 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.archive_safe` | production | P3 | 130 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.auth` | production | P3 | 9,541 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.auth_commands` | production | P3 | 901 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.backup` | production | P3 | 2,346 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.banner` | production | P3 | 1,302 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.browser_connect` | production | P3 | 1,459 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.build_info` | production | P3 | 168 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.bundles` | production | P3 | 230 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.checkpoints` | production | P3 | 281 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.claw` | production | P3 | 815 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.colors` | production | P3 | 38 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.commands` | production | P3 | 2,481 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.config` | production | P3 | 6,226 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.config_defaults` | production | P3 | 5,131 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.config_migrations` | production | P3 | 910 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.console_engine` | production | P3 | 1,696 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.copilot_auth` | production | P3 | 736 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.cron` | production | P3 | 843 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.dashboard_auth.cookies` | production | P3 | 418 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.dashboard_auth.native_flow` | production | P3 | 306 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.dashboard_auth.ws_tickets` | production | P3 | 161 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.debug` | production | P3 | 1,052 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.default_soul` | production | P3 | 112 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.dep_ensure` | production | P3 | 185 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.doctor` | production | P3 | 3,395 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.doctor_live` | production | P3 | 332 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.dump` | production | P3 | 451 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.env_loader` | production | P3 | 803 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.foreign_sessions` | production | P3 | 489 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.gateway` | production | P3 | 8,848 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.gateway_enroll` | production | P3 | 350 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.gateway_windows` | production | P3 | 1,710 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.gitlock` | production | P3 | 192 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.goals` | production | P3 | 2,326 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.heartbeat` | production | P3 | 335 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.hooks` | production | P3 | 438 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.image_provenance` | production | P3 | 137 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.input_sanitize` | production | P3 | 70 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.inventory` | production | P3 | 1,017 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.journey` | production | P3 | 414 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.kanban` | production | P3 | 3,542 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.kanban_db` | production | P3 | 12,150 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.kanban_diagnostics` | production | P3 | 1,216 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.kanban_swarm` | production | P3 | 390 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.kanban_transfer` | production | P3 | 478 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.lifecycle` | production | P3 | 63 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.linux_desktop_entry` | production | P3 | 209 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.loops` | production | P3 | 973 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.macos_tcc_anchor` | production | P3 | 444 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.main` | production | P3 | 14,786 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `hermes_cli.managed_scope` | production | P3 | 214 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.managed_uv` | production | P3 | 1,454 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.mcp_catalog` | production | P3 | 1,000 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.mcp_config` | production | P3 | 1,204 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.memory_setup` | production | P3 | 585 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.model_cost_guard` | production | P3 | 185 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.model_data_policy_guard` | production | P3 | 108 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.model_normalize` | production | P3 | 586 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.model_search` | production | P3 | 53 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.model_selection_guards` | production | P3 | 181 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.model_setup_flows` | production | P3 | 3,281 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.model_switch` | production | P3 | 4,016 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.models` | production | P3 | 7,302 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.nous_subscription` | production | P3 | 1,482 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.npm_engine` | production | P3 | 354 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.observability.relay_shared_metrics` | production | P3 | 1,295 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.observability.shared_metrics_contract` | production | P3 | 978 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.oneshot` | production | P3 | 567 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.personality` | production | P3 | 186 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.pets` | production | P3 | 506 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.platform_actions` | production | P3 | 238 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.plugin_capabilities` | production | P3 | 393 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.plugin_dev` | production | P3 | 365 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.plugin_index` | production | P3 | 305 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.plugin_packs` | production | P3 | 762 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.plugins` | production | P3 | 7,182 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.plugins_cmd` | production | P3 | 3,178 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.process_identity` | production | P3 | 575 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.profiles` | production | P3 | 2,510 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.projects_db` | production | P3 | 823 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.prompt_size` | production | P3 | 377 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.provider_catalog` | production | P3 | 186 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.providers` | production | P3 | 1,042 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.pt_input_extras` | production | P3 | 534 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.pty_session` | production | P3 | 205 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.relay_plugin_cutover` | production | P3 | 63 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.send_cmd` | production | P3 | 501 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.service_manager` | production | P3 | 1,133 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.session_export` | production | P3 | 383 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.session_lost_and_found` | production | P3 | 583 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.session_recovery` | production | P3 | 1,732 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.sessions_cmd` | production | P3 | 1,455 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.setup` | production | P3 | 3,876 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.setup_hidden_env` | production | P3 | 56 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.setup_whatsapp_cloud` | production | P3 | 542 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.sizefmt` | production | P3 | 36 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.skills_config` | production | P3 | 211 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.skills_hub` | production | P3 | 2,134 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.subcommands.cron` | production | P3 | 328 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.subcommands.gui` | production | P3 | 80 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.subcommands.peer` | production | P3 | 342 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.subcommands.plugins` | production | P3 | 230 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.subcommands.profile` | production | P3 | 209 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.subcommands.skills` | production | P3 | 348 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.subcommands.update` | production | P3 | 114 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.terminal_breadcrumbs` | production | P3 | 185 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.timefmt` | production | P3 | 30 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.timeouts` | production | P3 | 82 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.tips` | production | P3 | 512 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.tools_config` | production | P3 | 6,244 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.toolset_validation` | production | P3 | 74 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.uninstall` | production | P3 | 1,065 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.update_cmd` | production | P3 | 10,211 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.update_contract` | production | P3 | 138 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.update_inventory` | production | P3 | 522 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.update_receipt` | production | P3 | 508 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.update_restart_recovery` | production | P3 | 243 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.urllib_security` | production | P3 | 224 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.voice` | production | P3 | 1,072 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.web_git` | production | P3 | 868 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_models` | production | P3 | 755 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.web_routers.cron` | production | P3 | 339 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.git` | production | P3 | 196 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.mcp` | production | P3 | 577 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.profiles` | production | P3 | 1,262 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.sessions` | production | P3 | 877 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.skills` | production | P3 | 543 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_routers.tools` | production | P3 | 833 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.web_server` | production | P3 | 19,958 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_cli.worktree_cmd` | production | P3 | 99 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `hermes_cli.worktree_gc` | production | P3 | 432 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `hermes_constants` | production | P1 | 1,853 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `hermes_logging` | production | P1 | 801 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_state` | production | P1 | 15,316 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_state_common` | production | P1 | 934 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_state_portability` | production | P1 | 845 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_state_schema` | production | P1 | 1,529 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_state_search` | production | P1 | 2,510 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_time` | production | P1 | 135 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `mcp_serve` | production | P2 | 1,060 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `model_tools` | production | P2 | 1,689 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `optional-skills.software-development.ast-grep.scripts.ast_grep_helper` | production | P2 | 761 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.browser.browser_use.provider` | production | P4 | 351 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.cron_providers.chronos.__init__` | production | P4 | 267 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.hermes-achievements.dashboard.plugin_api` | production | P4 | 1,092 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.image_gen.fal.__init__` | production | P4 | 218 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.image_gen.krea.__init__` | production | P4 | 921 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.image_gen.openai-codex.__init__` | production | P4 | 770 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.image_gen.openrouter.__init__` | production | P4 | 1,485 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.image_gen.xai.__init__` | production | P4 | 625 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.kanban.dashboard.plugin_api` | production | P4 | 3,100 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.__init__` | production | P4 | 778 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.hindsight.__init__` | production | P4 | 2,470 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.hindsight.templates` | production | P4 | 153 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.holographic.store` | production | P4 | 688 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.honcho.__init__` | production | P4 | 1,712 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.honcho.cli` | production | P4 | 1,976 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.honcho.client` | production | P4 | 1,367 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.honcho.oauth` | production | P4 | 640 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.honcho.session` | production | P4 | 1,819 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.mem0._backend` | production | P4 | 358 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.mem0._openai_llm` | production | P4 | 100 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.mem0._setup` | production | P4 | 1,003 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.openviking.__init__` | production | P4 | 5,395 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.memory.retaindb.__init__` | production | P4 | 860 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.memory.supermemory.__init__` | production | P4 | 1,051 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.actual.__init__` | production | P4 | 91 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.ai-gateway.__init__` | production | P4 | 43 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.alibaba-coding-plan.__init__` | production | P4 | 40 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.alibaba.__init__` | production | P4 | 64 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `plugins.model-providers.commandcode.__init__` | production | P4 | 176 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.model-providers.copilot.__init__` | production | P4 | 80 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.custom.__init__` | production | P4 | 149 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.deepinfra.__init__` | production | P4 | 81 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.deepseek.__init__` | production | P4 | 111 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `plugins.model-providers.kimi-coding.__init__` | production | P4 | 144 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.meta-ai.__init__` | production | P4 | 117 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.minimax.__init__` | production | P4 | 97 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.nebius-token-factory.__init__` | production | P4 | 104 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.nous.__init__` | production | P4 | 142 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.novita.__init__` | production | P4 | 27 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.nvidia.__init__` | production | P4 | 59 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.ollama-cloud.__init__` | production | P4 | 95 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `plugins.model-providers.opencode-free.__init__` | production | P4 | 67 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.opencode-zen.__init__` | production | P4 | 221 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.openrouter.__init__` | production | P4 | 252 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.model-providers.router.__init__` | production | P4 | 395 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.model-providers.stepfun.__init__` | production | P4 | 14 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.model-providers.upstage.__init__` | production | P4 | 118 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `plugins.model-providers.zai.__init__` | production | P4 | 164 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `plugins.observability.langfuse.__init__` | production | P4 | 1,801 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.a2a.adapter` | production | P4 | 1,274 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.a2a.tools` | production | P4 | 631 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.buzz.adapter` | production | P4 | 1,530 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.dingtalk.adapter` | production | P4 | 1,932 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.discord.adapter` | production | P4 | 10,609 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.email.adapter` | production | P4 | 1,512 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.feishu.adapter` | production | P4 | 5,919 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.google_chat.adapter` | production | P4 | 3,749 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.homeassistant.adapter` | production | P4 | 606 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.irc.adapter` | production | P4 | 997 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.line.adapter` | production | P4 | 1,762 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.matrix.adapter` | production | P4 | 5,464 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.mattermost.adapter` | production | P4 | 1,340 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.ntfy.adapter` | production | P4 | 619 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.photon.adapter` | production | P4 | 2,955 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.raft.adapter` | production | P4 | 855 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.simplex.adapter` | production | P4 | 1,385 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.slack.adapter` | production | P4 | 9,925 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.sms.adapter` | production | P4 | 538 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.teams.adapter` | production | P4 | 1,672 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.telegram.adapter` | production | P4 | 11,203 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.platforms.telegram.inline_picker` | production | P4 | 166 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.telegram.telegram_network` | production | P4 | 347 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.wecom.adapter` | production | P4 | 3,594 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.platforms.whatsapp.adapter` | production | P4 | 1,932 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.plugin_storage` | production | P4 | 80 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.teams_pipeline.cli` | production | P4 | 468 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.teams_pipeline.meetings` | production | P4 | 470 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.teams_pipeline.pipeline` | production | P4 | 792 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `plugins.video_gen.deepinfra.__init__` | production | P4 | 92 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.video_gen.fal.__init__` | production | P4 | 1,061 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `plugins.video_gen.xai.__init__` | production | P4 | 927 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `providers.__init__` | production | P2 | 342 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `providers.base` | production | P2 | 296 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `registration_lifecycle` | production | P2 | 128 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `run_agent` | production | P2 | 9,338 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.analyze_livetest` | production | P2 | 124 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.check-windows-footguns` | production | P2 | 814 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.ci.assemble_review_comment` | production | P2 | 444 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `scripts.ci.classify_changes` | production | P2 | 249 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.ci.list_os_marked_tests` | production | P2 | 115 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `scripts.ci.live_comment` | production | P2 | 794 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.ci.publish_e2e_evidence` | production | P2 | 337 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.desktop-update.serve-ui` | production | P2 | 63 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.release` | production | P2 | 2,641 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `scripts.run_tests_parallel` | production | P2 | 1,262 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `scripts.tool_search_livetest_ue_disc` | production | P2 | 247 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `scripts.tool_search_livetest_ue_hard` | production | P2 | 326 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `scripts.toolperf_abeval.ab_eval` | production | P2 | 327 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `skills.productivity.docx.scripts.docx_comments` | production | P2 | 289 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_common` | production | P2 | 94 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_create` | production | P2 | 177 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_edit` | production | P2 | 250 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_read` | production | P2 | 149 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_revisions` | production | P2 | 147 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_template` | production | P2 | 70 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.scripts.docx_validate` | production | P2 | 156 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.docx.tests.test_docx_skill` | oracle/test | oracle | 525 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `skills.productivity.pdf.scripts._raster` | production | P2 | 76 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_create` | production | P2 | 130 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_fill_form` | production | P2 | 97 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_form_layout` | production | P2 | 168 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_make_form` | production | P2 | 145 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_merge` | production | P2 | 50 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_meta` | production | P2 | 115 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_page_image` | production | P2 | 99 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_read` | production | P2 | 153 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_secure` | production | P2 | 71 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_split` | production | P2 | 84 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_stamp` | production | P2 | 143 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.scripts.pdf_watermark` | production | P2 | 51 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.pdf.tests.test_pdf_skill` | oracle/test | oracle | 414 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `skills.productivity.powerpoint.scripts.pptx_create` | production | P2 | 214 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.powerpoint.scripts.pptx_edit` | production | P2 | 436 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.powerpoint.scripts.pptx_from_template` | production | P2 | 88 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.powerpoint.scripts.pptx_read` | production | P2 | 131 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.powerpoint.scripts.pptx_render` | production | P2 | 93 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.powerpoint.tests.test_powerpoint_skill` | oracle/test | oracle | 475 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `skills.productivity.xlsx.scripts.csv_to_xlsx` | production | P2 | 104 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_create` | production | P2 | 259 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_edit` | production | P2 | 263 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_read` | production | P2 | 160 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_recalc` | production | P2 | 111 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_restructure` | production | P2 | 337 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.scripts.xlsx_to_csv` | production | P2 | 69 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `skills.productivity.xlsx.tests.test_xlsx_skill` | oracle/test | oracle | 542 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `skills.research.blocked-page-recovery.scripts.recover_page` | production | P2 | 241 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tests.acp.test_named_provider_catalogs` | oracle/test | oracle | 279 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.acp.test_permissions` | oracle/test | oracle | 207 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.acp.test_session` | oracle/test | oracle | 380 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.acp_adapter.test_acp_logging_redaction` | oracle/test | P5 | 41 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.lsp._mock_lsp_server` | oracle/test | P2 | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.lsp.test_client_e2e` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.lsp.test_install_and_lint_fixes` | oracle/test | P2 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.lsp.test_service` | oracle/test | P2 | 282 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.lsp.test_shell_linter_lsp_skip` | oracle/test | P2 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_413_image_payload_recovery` | oracle/test | P2 | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_acp_openai_bridge` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_acp_provider_rails` | oracle/test | P2 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_adapter` | oracle/test | P2 | 1,905 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_billing_guidance` | oracle/test | P2 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_borrowed_row_authority` | oracle/test | P2 | 281 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_credential_persist_failure` | oracle/test | P2 | 447 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_keychain` | oracle/test | P2 | 349 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_anthropic_oauth_stress` | oracle/test | P2 | 387 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_anthropic_output_field_leak` | oracle/test | P2 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_request_blank_block_guard` | oracle/test | P2 | 108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_request_client_reuse` | oracle/test | P2 | 157 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_spent_rotation_verdict` | oracle/test | P2 | 391 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_anthropic_structured_output` | oracle/test | P2 | 214 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_anthropic_thinking_disable` | oracle/test | P2 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_arcee_trinity_overrides` | oracle/test | P2 | 189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_async_token_accounting` | oracle/test | P2 | 550 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_aux_progress_streaming` | oracle/test | P2 | 649 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_auxiliary_client` | oracle/test | P2 | 4,686 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_auxiliary_client_base_url_host_validation_52608` | oracle/test | P2 | 237 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_auxiliary_config_bridge` | oracle/test | P2 | 245 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_auxiliary_explicit_base_anthropic` | oracle/test | P2 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_auxiliary_main_first` | oracle/test | P2 | 620 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_background_review_tool_call_guard` | oracle/test | P2 | 125 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_background_review_usage` | oracle/test | P2 | 198 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_bedrock_adapter` | oracle/test | P2 | 1,435 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_bedrock_integration` | oracle/test | P2 | 593 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_bedrock_interrupt_post_worker` | oracle/test | P2 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_billing_unverified_carrythrough` | oracle/test | P2 | 171 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_bot_profile_prompt_isolation` | oracle/test | P2 | 132 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_builtin_memory_disabled_surface` | oracle/test | P2 | 315 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_codex_app_server_persist` | oracle/test | P2 | 199 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_codex_cloudflare_headers` | oracle/test | P2 | 197 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_codex_happy_eyeballs` | oracle/test | P2 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_codex_request_transport_diagnostics` | oracle/test | P2 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_codex_responses_adapter` | oracle/test | P2 | 627 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_codex_responses_settle_pending_tool_calls` | oracle/test | P2 | 399 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_codex_usage_attribution` | oracle/test | P2 | 360 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_command_token_source` | oracle/test | P2 | 349 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compaction_anti_thrash` | oracle/test | P2 | 259 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compaction_ops_notification_anchor` | oracle/test | P2 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_compression_adoption_preserves_live_tail` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compression_anti_thrash_persistence` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_compression_attempt_ownership` | oracle/test | P2 | 258 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compression_attempt_telemetry` | oracle/test | P2 | 200 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compression_concurrent_fork` | oracle/test | P2 | 2,208 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_compression_rotation_state` | oracle/test | P2 | 2,042 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compression_small_ctx_threshold_floor` | oracle/test | P2 | 158 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_compression_stall_fallback_78981` | oracle/test | P2 | 360 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_compressor_historical_media` | oracle/test | P2 | 392 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_compressor_stale_tool_images` | oracle/test | P2 | 211 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_context_compressor` | oracle/test | P2 | 3,678 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_context_compressor_structural_backoff` | oracle/test | P2 | 161 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_context_compressor_summary_continuity` | oracle/test | P2 | 461 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_context_compressor_zero_user_provenance` | oracle/test | P2 | 459 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_context_references` | oracle/test | P2 | 303 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_conversation_loop_interpreter_shutdown` | oracle/test | P2 | 68 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_copilot_acp_client` | oracle/test | P2 | 319 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_credential_pool` | oracle/test | P2 | 2,081 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_credential_pool_anthropic_refresh_race` | oracle/test | P2 | 309 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_credential_pool_oauth_writethrough` | oracle/test | P2 | 429 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_credential_pool_provider_boundary` | oracle/test | P2 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_credential_pool_routing` | oracle/test | P2 | 565 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_credential_pool_sole_cooldown` | oracle/test | P2 | 242 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_credits_policy` | oracle/test | P2 | 636 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_curator` | oracle/test | P2 | 928 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_curator_backup` | oracle/test | P2 | 486 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_custom_pool_mismatch_guard` | oracle/test | P2 | 164 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_custom_provider_ca_probes` | oracle/test | P2 | 312 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_deadline` | oracle/test | P2 | 737 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_empty_response_guard` | oracle/test | P2 | 357 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_empty_tool_name_loop_dampening` | oracle/test | P2 | 254 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_error_classifier` | oracle/test | P2 | 1,582 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_error_surface` | oracle/test | P2 | 216 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_failover_identity` | oracle/test | P2 | 356 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_fast_compression_lane` | oracle/test | P2 | 477 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_file_safety_cross_profile` | oracle/test | P2 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_gemini_native_adapter` | oracle/test | P2 | 677 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_hygiene_timeout_cooldown_isolation` | oracle/test | P2 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_image_routing` | oracle/test | P2 | 667 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_insights` | oracle/test | P2 | 776 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_interrupt_compat` | oracle/test | P2 | 123 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_learn_prompt` | oracle/test | P2 | 124 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_litellm_tool_part_cache_markers` | oracle/test | P2 | 127 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_load_time_durability_stamp_92231` | oracle/test | P2 | 193 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_manual_compression_refusal_feedback` | oracle/test | P2 | 58 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_memory_provider` | oracle/test | P2 | 1,466 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_memory_provider_unavailable_warning` | oracle/test | P2 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_memory_recall_indicator` | oracle/test | P2 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_message_metadata` | oracle/test | P2 | 23 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_message_sanitization_policy` | oracle/test | P2 | 480 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_meta_agent_init` | oracle/test | P2 | 200 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_meta_usage_cache_reporting` | oracle/test | P2 | 46 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_minimax_auxiliary_url` | oracle/test | P2 | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_moa_observability_bridge` | oracle/test | P2 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_moa_prepared_request_client_swap` | oracle/test | P2 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_moa_switch_api_mode` | oracle/test | P2 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_model_metadata` | oracle/test | P2 | 1,851 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_model_metadata_local_ctx` | oracle/test | P2 | 1,069 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_models_dev` | oracle/test | P2 | 1,307 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_models_dev_meta_mapping` | oracle/test | P2 | 8 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_native_preflight_estimate` | oracle/test | P2 | 100 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_opencode_free_provider` | oracle/test | P2 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_pet_engine` | oracle/test | P2 | 284 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_pet_generate` | oracle/test | P2 | 469 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_phantom_tool_references` | oracle/test | P2 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_plan_prompt` | oracle/test | P2 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_platform_hint_desktop` | oracle/test | P2 | 178 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_plugin_context_references` | oracle/test | P2 | 197 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_plugin_llm_task_routing` | oracle/test | P2 | 659 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_plugin_prompt_sections` | oracle/test | P2 | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_pre_compress_checkpoint_contract` | oracle/test | P2 | 438 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_probe_cache_followups` | oracle/test | P2 | 344 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_profile_home_override_precedence` | oracle/test | P2 | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_project_skills` | oracle/test | P2 | 243 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_prompt_builder` | oracle/test | P2 | 1,022 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_prompt_cache_boundary` | oracle/test | P2 | 382 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_prompt_cache_scope` | oracle/test | P2 | 571 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_prompt_cache_ttl_propagation` | oracle/test | P2 | 376 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_prompt_caching` | oracle/test | P2 | 884 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_provider_projection` | oracle/test | P2 | 213 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_pydantic_dump_warning_leak` | oracle/test | P2 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_reasoning_effort_module` | oracle/test | P2 | 173 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_reasoning_effort_wire_translation` | oracle/test | P2 | 54 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_reasoning_stale_timeout_floor` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_reference_handoff_active_turn` | oracle/test | P2 | 387 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_relay_llm` | oracle/test | P2 | 1,236 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_nested_execution` | oracle/test | P2 | 233 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_runtime_bounded_scope_ops` | oracle/test | P2 | 291 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_runtime_plugins` | oracle/test | P2 | 1,254 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_scope_pop_metadata` | oracle/test | P2 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_session_segments` | oracle/test | P2 | 413 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_relay_tools` | oracle/test | P2 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_repetition_guard` | oracle/test | P2 | 50 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_replay_budget_accounting` | oracle/test | P2 | 158 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_review_engine` | oracle/test | P2 | 519 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_run_budget` | oracle/test | P2 | 324 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_salvage_grown_transcript` | oracle/test | P2 | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_secret_scope` | oracle/test | P2 | 349 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_secret_scope_tier1_migration` | oracle/test | P2 | 264 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_sequential_tool_interrupt` | oracle/test | P2 | 195 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_session_rotation_flush_cold_resume_68454` | oracle/test | P2 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_shell_hooks` | oracle/test | P2 | 739 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_shell_hooks_tree_kill` | oracle/test | P2 | 160 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_side_question` | oracle/test | P2 | 199 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_skill_commands` | oracle/test | P2 | 881 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_skill_todo_retention_parity` | oracle/test | P2 | 328 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_skill_utils` | oracle/test | P2 | 384 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_skills_guidance_content_filter` | oracle/test | P2 | 97 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_skip_memory_store_65429` | oracle/test | P2 | 134 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_soul_md_profile_isolation` | oracle/test | P2 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_ssl_ca_guard` | oracle/test | P2 | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_stale_replay_prune` | oracle/test | P2 | 166 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_stall_guards` | oracle/test | P2 | 396 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_structured_output_rejection_retry` | oracle/test | P2 | 307 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_subagent_lifecycle` | oracle/test | P2 | 180 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_subagent_stop_hook` | oracle/test | P2 | 284 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_subdirectory_hints` | oracle/test | P2 | 299 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_surrogate_chokepoints` | oracle/test | P2 | 194 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_switch_model_request_overrides` | oracle/test | P2 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_system_prompt` | oracle/test | P2 | 666 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_system_prompt_restore` | oracle/test | P2 | 451 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_terminal_env_registry` | oracle/test | P2 | 204 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_thread_scoped_output` | oracle/test | P2 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_title_generator` | oracle/test | P2 | 599 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_tool_dispatch_helpers` | oracle/test | P2 | 312 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_trace_upload` | oracle/test | P2 | 179 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_treekill_consolidation` | oracle/test | P2 | 230 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_turn_context` | oracle/test | P2 | 454 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_turn_finalizer_final_response_persistence` | oracle/test | P2 | 411 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_turn_finalizer_iteration_limit_exit` | oracle/test | P2 | 375 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_turn_retry_state` | oracle/test | P2 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_uncompressed_context_guardrail` | oracle/test | P2 | 183 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_usage_anchor` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_usage_pricing` | oracle/test | P2 | 869 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.test_verification_evidence` | oracle/test | P2 | 352 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_verification_stop` | oracle/test | P2 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_vertex_adapter` | oracle/test | P2 | 285 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.test_would_grow_refusal_runway` | oracle/test | P2 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.transports.test_chat_completions` | oracle/test | P2 | 967 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.transports.test_chat_completions_empty_tool_calls` | oracle/test | P2 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.transports.test_codex_transport` | oracle/test | P2 | 1,355 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.agent.transports.test_meta_codex_cache` | oracle/test | P2 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.transports.test_reasoning_effort_sibling_sites` | oracle/test | P2 | 130 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.agent.transports.test_router_codex_efforts` | oracle/test | P2 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.ci.test_assemble_review_comment` | oracle/test | oracle | 357 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.ci.test_classify_changes` | oracle/test | oracle | 302 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.ci.test_list_os_marked_tests` | oracle/test | oracle | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.ci.test_live_comment` | oracle/test | oracle | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.ci.test_publish_e2e_evidence` | oracle/test | oracle | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_branch_command` | oracle/test | P3 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_approval_ui` | oracle/test | P3 | 596 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_background_busy_path` | oracle/test | P3 | 140 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_browser_connect` | oracle/test | P3 | 223 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_cli_clarify_batch` | oracle/test | P3 | 343 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_file_drop` | oracle/test | P3 | 206 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_force_redraw` | oracle/test | P3 | 428 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_init` | oracle/test | P3 | 697 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_cli_insights_command` | oracle/test | P3 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_cli_interrupt_ack_race` | oracle/test | P3 | 540 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_light_mode` | oracle/test | P3 | 414 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_pet_pane` | oracle/test | P3 | 265 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_preloaded_skills` | oracle/test | P3 | 155 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_cli_provider_resolution` | oracle/test | P3 | 682 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_retry` | oracle/test | P3 | 378 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_status_bar` | oracle/test | P3 | 717 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_status_command` | oracle/test | P3 | 133 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_cli_yolo_toggle` | oracle/test | P3 | 218 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_command_palette` | oracle/test | P3 | 101 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_ctrl_enter_newline` | oracle/test | P3 | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_exit_watchdog_signal_arm` | oracle/test | P3 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_fast_command` | oracle/test | P3 | 336 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_focus_view` | oracle/test | P3 | 395 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_handoff_cleanup_race` | oracle/test | P3 | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_handoff_slow_dispatch_timeout` | oracle/test | P3 | 259 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_interrupt_output_history_regression` | oracle/test | P3 | 326 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_model_picker_filter` | oracle/test | P3 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_modify_other_keys_aliases` | oracle/test | P3 | 562 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_oneshot_resumed_session_persist` | oracle/test | P3 | 202 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_personality_none` | oracle/test | P3 | 239 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_resume_display` | oracle/test | P3 | 457 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_resume_model_restore` | oracle/test | P3 | 367 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_save_conversation_location` | oracle/test | P3 | 134 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_show_config_credential` | oracle/test | P3 | 51 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_slash_confirm_windows` | oracle/test | P3 | 340 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cli.test_slash_undo_title_robustness` | oracle/test | P3 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_termios_drift_heal` | oracle/test | P3 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_transformed_stream_output` | oracle/test | P3 | 31 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_worktree` | oracle/test | P3 | 1,444 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cli.test_worktree_selfheal` | oracle/test | P3 | 144 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.computer_use.test_cua_cli_fallback_env` | oracle/test | oracle | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.computer_use.test_cua_no_overlay` | oracle/test | oracle | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.computer_use.test_cua_spawn_env_sanitization` | oracle/test | oracle | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.conformance.persistence.__init__` | oracle/test | oracle | 0 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.conformance.persistence._harness` | oracle/test | oracle | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.conformance.persistence.test_cell1_prefix_durability` | oracle/test | oracle | 141 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.conformance.persistence.test_cell2_consume_once` | oracle/test | oracle | 92 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.conformance.persistence.test_cell3_rotation_atomicity` | oracle/test | oracle | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.conformance.persistence.test_cells_wave2_stubs` | oracle/test | oracle | 47 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.conftest` | oracle/test | oracle | 1,754 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_87033_cronjob_gateway_liveness` | oracle/test | P4 | 320 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_agent_scheduling_gate` | oracle/test | P4 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_claim_job_for_fire` | oracle/test | P4 | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cleanup_timeout` | oracle/test | P4 | 140 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_cron_bot_chat_delivery` | oracle/test | P4 | 216 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_context_from` | oracle/test | P4 | 442 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_created_delivery` | oracle/test | P4 | 196 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_cron_direct_api_call_watchdog` | oracle/test | P4 | 468 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_drift_alert_once` | oracle/test | P4 | 161 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_emfile_stall_87644` | oracle/test | P4 | 221 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_empty_payload` | oracle/test | P4 | 558 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_failure_alert_remediation_hint` | oracle/test | P4 | 47 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_failure_summarizer_inactivity` | oracle/test | P4 | 115 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_import_error_skew_hint` | oracle/test | P4 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_cron_incidents` | oracle/test | P4 | 329 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_cron_no_agent` | oracle/test | P4 | 369 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_origin_synthetic_thread` | oracle/test | P4 | 82 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_cron_provider_pin` | oracle/test | P4 | 438 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_reasoning_effort` | oracle/test | P4 | 232 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_relay_delivery_guards` | oracle/test | P4 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_relay_run_forward` | oracle/test | P4 | 244 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_request_overrides` | oracle/test | P4 | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_run_stale_claim_reap_86721` | oracle/test | P4 | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_script` | oracle/test | P4 | 809 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_thread_seed_dm_keying` | oracle/test | P4 | 203 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_cron_workdir` | oracle/test | P4 | 300 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_dead_owner_claim_reclaim` | oracle/test | P4 | 205 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_due_stale_cron_edit` | oracle/test | P4 | 195 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_execution_ledger` | oracle/test | P4 | 417 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_fire_forward_failure_stamp` | oracle/test | P4 | 89 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_inflight_stale_guard` | oracle/test | P4 | 513 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_jobs` | oracle/test | P4 | 1,896 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_media_delivery_parity` | oracle/test | P4 | 330 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_media_send_timeout` | oracle/test | P4 | 98 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_mirror_origin_fallback` | oracle/test | P4 | 240 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_misfire_backstop_oneshot_grace` | oracle/test | P4 | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_misfire_catchup` | oracle/test | P4 | 163 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_monitor_kind` | oracle/test | P4 | 448 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_notepad` | oracle/test | P4 | 267 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_oneshot_dispatch_failure_run_claim` | oracle/test | P4 | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_oneshot_grace_due_scan` | oracle/test | P4 | 132 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_oneshot_guard_warning` | oracle/test | P4 | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_parallel_pool` | oracle/test | P4 | 416 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_persisted_error_rearm_legality` | oracle/test | P4 | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_recurring_eagain_redispatch` | oracle/test | P4 | 174 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_recurring_persisted_error_recovery` | oracle/test | P4 | 163 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_recurring_wedge_selfheal` | oracle/test | P4 | 241 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_relay_fronted_delivery` | oracle/test | P4 | 191 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_rewrite_skill_refs` | oracle/test | P4 | 267 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_run_one_job` | oracle/test | P4 | 372 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_scheduler` | oracle/test | P4 | 2,854 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_scheduler_completion_verification` | oracle/test | P4 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_scheduler_provider` | oracle/test | P4 | 693 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_script_claim_heartbeat` | oracle/test | P4 | 580 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_sessiondb_init_hang` | oracle/test | P4 | 382 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.cron.test_shutdown_interrupt` | oracle/test | P4 | 631 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.cron.test_terminal_job_rearm` | oracle/test | P4 | 245 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.desktop.test_bots_chat_live_append` | oracle/test | oracle | 79 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.desktop.test_bots_chat_stream_rekey` | oracle/test | oracle | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.e2e.conftest` | oracle/test | oracle | 461 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.stub_connector` | oracle/test | P4 | 131 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_identity_token_resolver` | oracle/test | P4 | 257 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_live_cards_flow_trace` | oracle/test | P4 | 133 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_ack_ambiguity` | oracle/test | P4 | 167 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_adapter` | oracle/test | P4 | 334 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_inbound_dedupe` | oracle/test | P4 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_interactive` | oracle/test | P4 | 362 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_live_cards` | oracle/test | P4 | 277 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_media` | oracle/test | P4 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_multiplatform_semantics` | oracle/test | P4 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_passthrough` | oracle/test | P4 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_registration` | oracle/test | P4 | 140 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_roundtrip_telegram` | oracle/test | P4 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_seal_cancellation` | oracle/test | P4 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_relay_slack_unfurl` | oracle/test | P4 | 476 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_state_bounds` | oracle/test | P4 | 47 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_stream_semantics_gating` | oracle/test | P4 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_task_card_failures` | oracle/test | P4 | 47 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_threads` | oracle/test | P4 | 560 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.relay.test_relay_turn_keying` | oracle/test | P4 | 194 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_wire_voice_media` | oracle/test | P4 | 348 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.relay.test_ws_transport_hardening` | oracle/test | P4 | 373 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.restart_test_helpers` | oracle/test | P4 | 167 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_73771_media_resend_dedup` | oracle/test | P4 | 537 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_abandoned_turn_process_cleanup` | oracle/test | P4 | 329 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_adapter_connect_classification` | oracle/test | P4 | 450 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_api_server` | oracle/test | P4 | 3,070 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_api_server_compaction_projection` | oracle/test | P4 | 224 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_api_server_jobs` | oracle/test | P4 | 559 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_api_server_multiplex_secret_scope` | oracle/test | P4 | 163 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_api_server_profile_prefix_misdelivery` | oracle/test | P4 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_api_server_reasoning_ladder` | oracle/test | P4 | 33 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_api_server_runs` | oracle/test | P4 | 808 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_approval_boundary` | oracle/test | P4 | 414 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_approval_send_timeout_ambiguity` | oracle/test | P4 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_background_command` | oracle/test | P4 | 299 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_background_process_notifications` | oracle/test | P4 | 615 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_baseexception_turn_notify` | oracle/test | P4 | 124 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_bluebubbles` | oracle/test | P4 | 569 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_branch_routing_columns` | oracle/test | P4 | 155 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_browser_control_api` | oracle/test | P4 | 720 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_browser_control_artifacts` | oracle/test | P4 | 721 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_browser_control_broker` | oracle/test | P4 | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_browser_control_broker_hardening` | oracle/test | P4 | 569 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_browser_control_cloud` | oracle/test | P4 | 588 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_busy_command` | oracle/test | P4 | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_cached_agent_history_guard` | oracle/test | P4 | 67 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_channel_directory` | oracle/test | P4 | 400 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_clarify_active_session_bypass` | oracle/test | P4 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_clarify_send_timeout_ambiguity` | oracle/test | P4 | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_clarify_thread_followup_not_swallowed` | oracle/test | P4 | 266 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_command_bypass_active_session` | oracle/test | P4 | 457 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_completion_delivery` | oracle/test | P4 | 886 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_completion_session_boundary` | oracle/test | P4 | 336 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_compression_progress_notices` | oracle/test | P4 | 116 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_config` | oracle/test | P4 | 1,393 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_config_driven_access_policy` | oracle/test | P4 | 352 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_control_socket` | oracle/test | P4 | 405 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_control_socket_pause` | oracle/test | P4 | 109 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_control_socket_windows_live` | oracle/test | P4 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_cron_active_work_drain` | oracle/test | P4 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_cron_drain_floor` | oracle/test | P4 | 196 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_cron_fire_webhook` | oracle/test | P4 | 410 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_cron_interrupt_notification` | oracle/test | P4 | 229 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_custom_provider_request_overrides` | oracle/test | P4 | 307 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_delivery` | oracle/test | P4 | 404 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_delivery_ledger` | oracle/test | P4 | 722 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_delivery_ledger_producer` | oracle/test | P4 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_discord_connect` | oracle/test | P4 | 709 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_discord_model_picker_partition` | oracle/test | P4 | 157 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_discord_platform_events` | oracle/test | P4 | 388 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_discord_plugin_setup` | oracle/test | P4 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_discord_split_cap` | oracle/test | P4 | 156 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_disk_status` | oracle/test | P4 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_display_config` | oracle/test | P4 | 329 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_draft_id_restart_uniqueness` | oracle/test | P4 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_email` | oracle/test | P4 | 1,126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_email_charset_fallback` | oracle/test | P4 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_external_drain_control` | oracle/test | P4 | 328 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_fence_chunker` | oracle/test | P4 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_finalize_session_off_loop` | oracle/test | P4 | 152 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_gateway_command_dispatch_minimal` | oracle/test | P4 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_gateway_platform_event_hook` | oracle/test | P4 | 741 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_gateway_shutdown` | oracle/test | P4 | 347 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_gateway_silence_tokens` | oracle/test | P4 | 197 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_goal_max_turns_config` | oracle/test | P4 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_goal_resume_restart` | oracle/test | P4 | 202 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_goal_verdict_send` | oracle/test | P4 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_google_chat` | oracle/test | P4 | 1,789 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_handoff_secondary_profile_adapter` | oracle/test | P4 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_handoff_watcher_multiprofile` | oracle/test | P4 | 251 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_handoff_watcher_resilience` | oracle/test | P4 | 337 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_hygiene_failure_cooldown_ladder` | oracle/test | P4 | 422 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_interim_send_lanes` | oracle/test | P4 | 83 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_internal_notification_marker_82888` | oracle/test | P4 | 288 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_kanban_changes_requested_notifier` | oracle/test | P4 | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_kanban_notifier` | oracle/test | P4 | 747 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_kanban_notifier_apiserver_wake` | oracle/test | P4 | 219 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_kanban_notifier_wake_only_ordering` | oracle/test | P4 | 202 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_kanban_wake_scope` | oracle/test | P4 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_lifecycle_ledger` | oracle/test | P4 | 216 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_local_model_connection_reply` | oracle/test | P4 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_loop_command` | oracle/test | P4 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_loop_liveness_watchdog` | oracle/test | P4 | 405 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_matrix_media_filename` | oracle/test | P4 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_media_extraction` | oracle/test | P4 | 575 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_media_tag_cleanup` | oracle/test | P4 | 98 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_memory_status` | oracle/test | P4 | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_model_command_profile_config` | oracle/test | P4 | 81 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_model_command_request_overrides` | oracle/test | P4 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_multiplex_adapter_registry` | oracle/test | P4 | 850 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_adapter_session_key_namespace` | oracle/test | P4 | 195 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_api_server_routing` | oracle/test | P4 | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_multiplex_busy_input_mode` | oracle/test | P4 | 444 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_multiplex_http_routing` | oracle/test | P4 | 68 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_lifecycle` | oracle/test | P4 | 125 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_multiplex_phase0` | oracle/test | P4 | 174 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_profile_authz` | oracle/test | P4 | 170 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_session_db_profile_scope` | oracle/test | P4 | 459 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_multiplex_toolsets_profile_isolation` | oracle/test | P4 | 204 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_normalize_empty_agent_response` | oracle/test | P4 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_notice_delivery` | oracle/test | P4 | 52 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_notify_fatal_error_shield` | oracle/test | P4 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_pairing` | oracle/test | P4 | 705 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_peer_dm_hidden_e2e` | oracle/test | P4 | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_pending_drain_race` | oracle/test | P4 | 228 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_pending_queue_spool` | oracle/test | P4 | 223 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_per_platform_streaming_defaults` | oracle/test | P4 | 23 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_platform_authz_scope` | oracle/test | P4 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_platform_base` | oracle/test | P4 | 1,488 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_platform_plugin_handlers` | oracle/test | P4 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_platform_reconnect` | oracle/test | P4 | 1,239 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_platform_reconnect_fd_leak` | oracle/test | P4 | 321 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_platform_registry` | oracle/test | P4 | 711 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_plugin_message_injection` | oracle/test | P4 | 562 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_poller_fd_lifecycle` | oracle/test | P4 | 197 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_profile_resolution` | oracle/test | P4 | 389 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_qqbot` | oracle/test | P4 | 1,273 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_qqbot_scope_paths` | oracle/test | P4 | 285 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_readiness` | oracle/test | P4 | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_reasoning_config_per_model` | oracle/test | P4 | 144 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_relay_completion_injection_routing` | oracle/test | P4 | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_relay_delivery_followups` | oracle/test | P4 | 475 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_relay_final_delivery_incident` | oracle/test | P4 | 152 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_relay_injection_egress_priming` | oracle/test | P4 | 189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_relay_seal_failure` | oracle/test | P4 | 135 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_relay_teardown_drain` | oracle/test | P4 | 101 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_replace_child_reap` | oracle/test | P4 | 263 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_restart_after_turn` | oracle/test | P4 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_restart_drain` | oracle/test | P4 | 470 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_restart_resume_pending` | oracle/test | P4 | 1,168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_resume_command` | oracle/test | P4 | 885 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_retry_replacement` | oracle/test | P4 | 584 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_review_command` | oracle/test | P4 | 155 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_run_progress_topics` | oracle/test | P4 | 1,927 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_runner_startup_failures` | oracle/test | P4 | 447 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_scale_to_zero` | oracle/test | P4 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_scale_to_zero_watcher` | oracle/test | P4 | 538 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_send_image_file` | oracle/test | P4 | 265 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_send_multiple_images` | oracle/test | P4 | 408 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_session` | oracle/test | P4 | 1,646 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_session_api` | oracle/test | P4 | 893 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_session_continuity_82616` | oracle/test | P4 | 242 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_session_db_recovery` | oracle/test | P4 | 361 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_session_hygiene` | oracle/test | P4 | 1,542 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_session_reset_notify` | oracle/test | P4 | 331 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_session_store_runtime_stale_guard` | oracle/test | P4 | 316 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_session_store_stale_prune` | oracle/test | P4 | 306 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_session_title_rename_lane` | oracle/test | P4 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_sethome_synthetic_thread` | oracle/test | P4 | 48 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_shutdown_cache_cleanup` | oracle/test | P4 | 178 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_shutdown_flush` | oracle/test | P4 | 170 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_signal` | oracle/test | P4 | 1,455 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_simplex_plugin` | oracle/test | P4 | 390 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_skip_context_files_wiring` | oracle/test | P4 | 89 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_slack` | oracle/test | P4 | 5,867 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_slack_block_kit_adapter` | oracle/test | P4 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_slack_mention` | oracle/test | P4 | 620 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_slack_mention_humanization` | oracle/test | P4 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_slack_native_streaming` | oracle/test | P4 | 230 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_slack_sdk_response` | oracle/test | P4 | 419 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_slack_turn_recipient_identity` | oracle/test | P4 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_slack_unfurl_duplicate_turn` | oracle/test | P4 | 305 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_split_final_suffix_reconcile` | oracle/test | P4 | 109 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stale_finalize_suppression` | oracle/test | P4 | 618 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_stale_platform_lock_retryable` | oracle/test | P4 | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_startup_connect_parallel` | oracle/test | P4 | 288 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_status` | oracle/test | P4 | 1,439 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_status_command` | oracle/test | P4 | 591 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stderr_formatting` | oracle/test | P4 | 28 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stream_abandon_on_turn_death` | oracle/test | P4 | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stream_consumer_draft` | oracle/test | P4 | 451 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stream_consumer_tool_progress` | oracle/test | P4 | 313 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_stream_consumer_wecom_native` | oracle/test | P4 | 1,135 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_stream_final_adoption_gate` | oracle/test | P4 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_stream_final_contract` | oracle/test | P4 | 268 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_suppression_contract_matrix` | oracle/test | P4 | 272 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_teams` | oracle/test | P4 | 1,108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_teams_dotenv_isolation` | oracle/test | P4 | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_approval_buttons` | oracle/test | P4 | 332 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_auth_check` | oracle/test | P4 | 372 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_channel_posts` | oracle/test | P4 | 150 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_clarify_buttons` | oracle/test | P4 | 256 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_closewait_limits_31599` | oracle/test | P4 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_conflict` | oracle/test | P4 | 647 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_connect` | oracle/test | P4 | 29 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_documents` | oracle/test | P4 | 543 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_fallback_pool_release_71593` | oracle/test | P4 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_format` | oracle/test | P4 | 659 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_init_deadline` | oracle/test | P4 | 111 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_inline_picker` | oracle/test | P4 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_lazy_install_typehandler` | oracle/test | P4 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_max_doc_bytes` | oracle/test | P4 | 23 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_media_read_timeout` | oracle/test | P4 | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_mention_boundaries` | oracle/test | P4 | 160 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_model_picker` | oracle/test | P4 | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_network` | oracle/test | P4 | 569 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_network_reconnect` | oracle/test | P4 | 792 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_pending_update_probe` | oracle/test | P4 | 83 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_polling_health_confirmation` | oracle/test | P4 | 85 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_polling_progress` | oracle/test | P4 | 530 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_polling_stall_watchdog` | oracle/test | P4 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_reply_mode` | oracle/test | P4 | 311 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_reply_quote` | oracle/test | P4 | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_rich_messages` | oracle/test | P4 | 834 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_send_draft_format` | oracle/test | P4 | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_send_path_health` | oracle/test | P4 | 78 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_send_reconnect_wait` | oracle/test | P4 | 123 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_slash_confirm` | oracle/test | P4 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_start_polling_timeout` | oracle/test | P4 | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_status_indicator` | oracle/test | P4 | 45 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_status_update` | oracle/test | P4 | 108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_text_batching` | oracle/test | P4 | 532 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_thread_fallback` | oracle/test | P4 | 727 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_topic_mode` | oracle/test | P4 | 832 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_typing_backoff` | oracle/test | P4 | 86 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_telegram_voice_caption_markdown` | oracle/test | P4 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_telegram_voice_duration` | oracle/test | P4 | 116 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_tool_response_drop_recovery` | oracle/test | P4 | 331 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_tts_media_routing` | oracle/test | P4 | 583 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_tui_approval_redaction` | oracle/test | P4 | 67 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_tui_slash_worker_path` | oracle/test | P4 | 48 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_turn_context` | oracle/test | P4 | 147 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_turn_request_overrides` | oracle/test | P4 | 140 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_undo_rewind_session` | oracle/test | P4 | 146 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_update_command` | oracle/test | P4 | 546 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_usage_command` | oracle/test | P4 | 277 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_vision_preprocess` | oracle/test | P4 | 34 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_voice_transcode` | oracle/test | P4 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_webhook_adapter` | oracle/test | P4 | 1,026 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_webhook_offloop_delivery` | oracle/test | P4 | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_webhook_route_toolsets` | oracle/test | P4 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_wecom` | oracle/test | P4 | 1,521 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_wecom_double_send` | oracle/test | P4 | 534 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_wecom_per_turn` | oracle/test | P4 | 403 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_wecom_stream_dup_fix` | oracle/test | P4 | 330 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_weixin_secret_scope` | oracle/test | P4 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_whatsapp_connect` | oracle/test | P4 | 493 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_ws_auth_retry` | oracle/test | P4 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.gateway.test_ws_auth_retry_verifier_probe` | oracle/test | P4 | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.gateway.test_yuanbao_secret_scope` | oracle/test | P4 | 72 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.fixtures.plugin_compat_legacy.__init__` | oracle/test | P3 | 16 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_25106_global_switch_persists_base_url_api_mode` | oracle/test | P3 | 141 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_active_sessions` | oracle/test | P3 | 562 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_actual_provider` | oracle/test | P3 | 373 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_agent_env_advertisement` | oracle/test | P3 | 93 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_agent_plugins` | oracle/test | P3 | 560 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_anthropic_pool_model_discovery` | oracle/test | P3 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_api_key_providers` | oracle/test | P3 | 1,262 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_api_mode_aliases` | oracle/test | P3 | 120 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_approval_transport` | oracle/test | P3 | 562 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_auth_commands` | oracle/test | P3 | 1,112 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_auth_key_prefix_skip` | oracle/test | P3 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_auth_nous_provider` | oracle/test | P3 | 1,180 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_auth_provider_gate` | oracle/test | P3 | 281 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_auth_provider_scope` | oracle/test | P3 | 82 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_auth_ssl_macos` | oracle/test | P3 | 86 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_auth_store_lock_concurrent` | oracle/test | P3 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_auth_store_windows_encoding` | oracle/test | P3 | 356 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_aux_config` | oracle/test | P3 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_backup` | oracle/test | P3 | 1,856 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_backup_all_profiles` | oracle/test | P3 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_backup_path_errors` | oracle/test | P3 | 38 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_banner_git_state` | oracle/test | P3 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_banner_skills` | oracle/test | P3 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_base_url_host_identity` | oracle/test | P3 | 156 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_bedrock_mantle_key_env` | oracle/test | P3 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_bedrock_model_picker` | oracle/test | P3 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_bounded_probe_run` | oracle/test | P3 | 112 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_browser_connect_default_chromium` | oracle/test | P3 | 178 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_busy_policy_invariants` | oracle/test | P3 | 66 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cached_fetch_api_models` | oracle/test | P3 | 362 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_canonical_custom_identity` | oracle/test | P3 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_chat_c_fail_loudly` | oracle/test | P3 | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_chat_query_file` | oracle/test | P3 | 86 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cli_model_once` | oracle/test | P3 | 151 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_cli_output` | oracle/test | P3 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_cli_startup_model_cost_guard` | oracle/test | P3 | 309 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cmd_update` | oracle/test | P3 | 1,418 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_cmd_update_apt` | oracle/test | P3 | 47 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_cmd_update_docker` | oracle/test | P3 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_codex_models` | oracle/test | P3 | 241 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_commands` | oracle/test | P3 | 1,262 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_completer_config_reads` | oracle/test | P3 | 139 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_composer_placeholder` | oracle/test | P3 | 13 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_computer_use_cli` | oracle/test | P3 | 166 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_config` | oracle/test | P3 | 1,797 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_config_read_guard` | oracle/test | P3 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_config_set_coercion` | oracle/test | P3 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_config_set_list_values` | oracle/test | P3 | 161 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_config_validation` | oracle/test | P3 | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_console_engine` | oracle/test | P3 | 607 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_copilot_auth` | oracle/test | P3 | 194 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cron` | oracle/test | P3 | 385 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cron_fire_dashboard` | oracle/test | P3 | 543 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_cron_model_impact` | oracle/test | P3 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_cron_profile_enumeration_lightweight` | oracle/test | P3 | 37 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_curator_pin_unmanaged` | oracle/test | P3 | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_curator_pin_visibility` | oracle/test | P3 | 199 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_curses_arrow_keys` | oracle/test | P3 | 358 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_custom_opencode_family_runtime` | oracle/test | P3 | 79 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_custom_provider_context_length` | oracle/test | P3 | 218 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_custom_provider_model_switch` | oracle/test | P3 | 542 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_admin_endpoints` | oracle/test | P3 | 1,065 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_auth_cookies` | oracle/test | P3 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_dashboard_auth_gate` | oracle/test | P3 | 481 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_dashboard_auth_middleware` | oracle/test | P3 | 386 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_dashboard_auth_native_flow` | oracle/test | P3 | 590 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_auth_plugin_hook` | oracle/test | P3 | 257 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_auth_ws_auth` | oracle/test | P3 | 475 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_lifecycle_flags` | oracle/test | P3 | 173 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_spawn_executable` | oracle/test | P3 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_dashboard_unified_launch` | oracle/test | P3 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_deferred_platform_client_tools` | oracle/test | P3 | 474 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_deleted_profile_tombstone` | oracle/test | P3 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_dep_ensure` | oracle/test | P3 | 125 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_deprecated_cwd_warning` | oracle/test | P3 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_desktop_cron_ticker_profiles` | oracle/test | P3 | 120 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_desktop_exe_integrity` | oracle/test | P3 | 321 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_desktop_lifecycle_windows_live` | oracle/test | P3 | 144 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_doctor` | oracle/test | P3 | 1,666 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_doctor_dedicated_provider_skip` | oracle/test | P3 | 44 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_doctor_journal_modes` | oracle/test | P3 | 454 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_doctor_live` | oracle/test | P3 | 316 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_early_recovery` | oracle/test | P3 | 547 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_ensure_acp_launcher` | oracle/test | P3 | 69 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_ensure_gateway_service` | oracle/test | P3 | 152 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_ensure_hermes_home_uid_34107` | oracle/test | P3 | 135 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_ensure_windows_bin_launchers` | oracle/test | P3 | 342 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_env_loader` | oracle/test | P3 | 622 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_fleet_config_migration_windows_live` | oracle/test | P3 | 51 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_fleet_matrix_down_state` | oracle/test | P3 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_foreign_sessions` | oracle/test | P3 | 261 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway` | oracle/test | P3 | 1,189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_enroll_multiplex_warning` | oracle/test | P3 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_external_supervisor` | oracle/test | P3 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_foreign_xdg_runtime` | oracle/test | P3 | 141 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_gateway_platform_gating` | oracle/test | P3 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_proc_fallback` | oracle/test | P3 | 334 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_restart_loop` | oracle/test | P3 | 2,089 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_gateway_service` | oracle/test | P3 | 2,589 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_gateway_windows` | oracle/test | P3 | 372 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gateway_wsl` | oracle/test | P3 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_gitlock_tmp_packs` | oracle/test | P3 | 101 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_global_auth_store_memo` | oracle/test | P3 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_goal_gates` | oracle/test | P3 | 254 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_goal_judge_timeout_config` | oracle/test | P3 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_goals_db_bootstrap_off_loop` | oracle/test | P3 | 170 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_graphical_browser_detection` | oracle/test | P3 | 66 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_gui_command` | oracle/test | P3 | 1,267 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_hatch_prompt_thread_safety` | oracle/test | P3 | 39 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_imagegen_managed_gateway` | oracle/test | P3 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_in_dir_msys_paths` | oracle/test | P3 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_install_cua_driver` | oracle/test | P3 | 1,760 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_inventory` | oracle/test | P3 | 687 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_inventory_pricing` | oracle/test | P3 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_inventory_reasoning_caps` | oracle/test | P3 | 157 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_journey_render` | oracle/test | P3 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_cli` | oracle/test | P3 | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_cli_exit_status` | oracle/test | P3 | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_db` | oracle/test | P3 | 1,649 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_db_init` | oracle/test | P3 | 237 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_db_repair` | oracle/test | P3 | 289 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_dispatch_tick_hook` | oracle/test | P3 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_host_cap` | oracle/test | P3 | 313 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_memory_guard` | oracle/test | P3 | 253 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_notify` | oracle/test | P3 | 1,132 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_parent_reopen_invalidation` | oracle/test | P3 | 230 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_review_lifecycle` | oracle/test | P3 | 710 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_review_lifecycle_complete` | oracle/test | P3 | 709 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_review_surfaces` | oracle/test | P3 | 427 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_swarm` | oracle/test | P3 | 262 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_task_updated_hook` | oracle/test | P3 | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_kanban_transfer` | oracle/test | P3 | 364 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_worker_lifecycle_hooks` | oracle/test | P3 | 210 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_kanban_worktree_teardown` | oracle/test | P3 | 220 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_lazy_command_exports` | oracle/test | P3 | 66 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_lazy_refresh_venv_repair` | oracle/test | P3 | 265 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_linux_desktop_entry` | oracle/test | P3 | 266 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_list_picker_providers` | oracle/test | P3 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_loops` | oracle/test | P3 | 713 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_macos_fda_guidance` | oracle/test | P3 | 97 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_macos_tcc_anchor` | oracle/test | P3 | 631 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_managed_install_shapes` | oracle/test | P3 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_managed_scope_config` | oracle/test | P3 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_managed_uv` | oracle/test | P3 | 1,356 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_mcp_catalog` | oracle/test | P3 | 899 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_mcp_catalog_env_boundary` | oracle/test | P3 | 254 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_mcp_config` | oracle/test | P3 | 842 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_mcp_helper_ledger` | oracle/test | P3 | 220 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_mem_trim` | oracle/test | P3 | 218 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_memory_setup` | oracle/test | P3 | 123 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_memory_setup_env_denylist` | oracle/test | P3 | 187 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_memory_status_env_hint` | oracle/test | P3 | 43 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_meta_prompt_cache` | oracle/test | P3 | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_cache_parallel_prefetch` | oracle/test | P3 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_cost_guard` | oracle/test | P3 | 173 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_model_data_policy_guard` | oracle/test | P3 | 38 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_picker_secret_scope` | oracle/test | P3 | 99 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_search` | oracle/test | P3 | 32 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_selection_guards` | oracle/test | P3 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_switch_confirm_thread` | oracle/test | P3 | 161 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_switch_custom_providers` | oracle/test | P3 | 2,225 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_switch_openai_api_mode` | oracle/test | P3 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_model_validation` | oracle/test | P3 | 806 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_models` | oracle/test | P3 | 1,484 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_nebius_token_factory_provider` | oracle/test | P3 | 256 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_noninteractive_git` | oracle/test | P3 | 180 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_nous_reasoning_metadata` | oracle/test | P3 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_nous_subscription` | oracle/test | P3 | 565 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_npm_engine` | oracle/test | P3 | 388 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_ollama_cloud_auth` | oracle/test | P3 | 472 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_oneshot_skills` | oracle/test | P3 | 57 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_oneshot_surrogate` | oracle/test | P3 | 39 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_opencode_free_live_catalog` | oracle/test | P3 | 221 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_opencode_zen_free_keyless` | oracle/test | P3 | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_openrouter_reasoning_metadata` | oracle/test | P3 | 268 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_orphan_desktop_serve_reap` | oracle/test | P3 | 390 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_peer_cmd` | oracle/test | P3 | 322 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_personality_single_owner` | oracle/test | P3 | 223 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_pet_toggle` | oracle/test | P3 | 103 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_plan_reconciliation_windows_live` | oracle/test | P3 | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_platform_actions` | oracle/test | P3 | 279 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_api_compat` | oracle/test | P3 | 52 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_plugin_call_mcp` | oracle/test | P3 | 207 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_capabilities` | oracle/test | P3 | 434 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_plugin_config_state_bridge` | oracle/test | P3 | 328 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_dev` | oracle/test | P3 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_event_bus` | oracle/test | P3 | 531 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_index_search` | oracle/test | P3 | 498 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_install_ref` | oracle/test | P3 | 366 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_manifest_v2` | oracle/test | P3 | 411 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_message_injection` | oracle/test | P3 | 204 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_ownership_ledger` | oracle/test | P3 | 1,364 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_packs` | oracle/test | P3 | 561 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugin_prompt_sections` | oracle/test | P3 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_plugins` | oracle/test | P3 | 2,326 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugins_cmd` | oracle/test | P3 | 823 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugins_cmd_category_discovery` | oracle/test | P3 | 310 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugins_cmd_enable_disable_nested` | oracle/test | P3 | 232 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_plugins_cmd_list` | oracle/test | P3 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_post_setup_gating` | oracle/test | P3 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_pre_command_hook` | oracle/test | P3 | 409 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_process_identity` | oracle/test | P3 | 244 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_profile_display_name` | oracle/test | P3 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_profile_export_credentials` | oracle/test | P3 | 138 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_profiles` | oracle/test | P3 | 1,179 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_profiles_sidebar_cache` | oracle/test | P3 | 153 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_profiles_sidebar_scope` | oracle/test | P3 | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_projects_db` | oracle/test | P3 | 146 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_provider_catalog` | oracle/test | P3 | 79 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_provider_config_validation` | oracle/test | P3 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_provider_parity` | oracle/test | P3 | 92 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_prune_spares_pinned` | oracle/test | P3 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_quarantine_noop_restore` | oracle/test | P3 | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_quarantine_orphan_rescue` | oracle/test | P3 | 347 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_reasoning_caps_disk_cache` | oracle/test | P3 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_relaunch` | oracle/test | P3 | 240 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_relay_plugin_cutover` | oracle/test | P3 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_relay_shared_metrics` | oracle/test | P3 | 1,528 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_relay_shared_metrics_runtime` | oracle/test | P3 | 2,602 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_resolve_ephemeral_system_prompt` | oracle/test | P3 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_resolve_turn_limit` | oracle/test | P3 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_restart_plan_reconciliation` | oracle/test | P3 | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_resume_latest_and_in_dir` | oracle/test | P3 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_router_provider` | oracle/test | P3 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_runtime_provider_late_binding` | oracle/test | P3 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_runtime_provider_resolution` | oracle/test | P3 | 1,749 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_sale_pricing` | oracle/test | P3 | 189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_scan_venv_blockers` | oracle/test | P3 | 370 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_secret_source_bootstrap` | oracle/test | P3 | 256 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_seeded_interactive_query` | oracle/test | P3 | 124 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_send_cmd` | oracle/test | P3 | 377 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_serve_parent_watchdog` | oracle/test | P3 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_serve_port_in_use` | oracle/test | P3 | 244 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_serve_runtime_inventory` | oracle/test | P3 | 218 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_service_manager` | oracle/test | P3 | 534 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_session_export_html` | oracle/test | P3 | 78 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_session_owner_backfill` | oracle/test | P3 | 141 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_session_recovery_lost_and_found` | oracle/test | P3 | 571 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_session_save` | oracle/test | P3 | 87 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_sessions_delete` | oracle/test | P3 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_sessions_error_exit_codes` | oracle/test | P3 | 49 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_sessions_pin` | oracle/test | P3 | 138 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_set_config_value` | oracle/test | P3 | 778 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_setup_blank_slate` | oracle/test | P3 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_setup_prompt_menus` | oracle/test | P3 | 219 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_setup_reconfigure` | oracle/test | P3 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_shim_fail_closed_windows_live` | oracle/test | P3 | 140 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_sibling_config_migration` | oracle/test | P3 | 124 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_sizefmt` | oracle/test | P3 | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_skills_hub` | oracle/test | P3 | 491 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_skills_uninstall_flags` | oracle/test | P3 | 58 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_spawn_gateway_restart_cooldown` | oracle/test | P3 | 228 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_spawn_gateway_restart_reap` | oracle/test | P3 | 67 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_ssh_ownership_endpoint` | oracle/test | P3 | 160 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_startup_plugin_gating` | oracle/test | P3 | 208 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_stderr_timestamp` | oracle/test | P3 | 159 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_stt_picker` | oracle/test | P3 | 125 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_subcommands_batch` | oracle/test | P3 | 134 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_tencent_tokenhub_provider` | oracle/test | P3 | 362 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_terminal_breadcrumbs` | oracle/test | P3 | 204 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_terminal_io_broken_81521` | oracle/test | P3 | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_terminal_menu_fallbacks` | oracle/test | P3 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_tools_config` | oracle/test | P3 | 1,221 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_tools_disable_enable` | oracle/test | P3 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_top_level_value_flags_parity` | oracle/test | P3 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_tui_launcher_skips_plugin_discovery` | oracle/test | P3 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_tui_npm_install` | oracle/test | P3 | 779 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_uninstall_windows_bin_launchers` | oracle/test | P3 | 116 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_apply_shallow_count` | oracle/test | P3 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_autostash` | oracle/test | P3 | 437 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_behind_count_recovery` | oracle/test | P3 | 198 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_bootstrap_cache_refresh` | oracle/test | P3 | 151 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_check` | oracle/test | P3 | 249 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_cold_start_gateway_liveness` | oracle/test | P3 | 52 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_concurrent_quarantine` | oracle/test | P3 | 1,037 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_config_migration_on_current` | oracle/test | P3 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_config_migration_on_current_checkout` | oracle/test | P3 | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_contract` | oracle/test | P3 | 177 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_current_node_repair` | oracle/test | P3 | 44 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_desktop_stale_warning` | oracle/test | P3 | 168 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_fetch_failure_classifier` | oracle/test | P3 | 77 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_fleet_check_fail_closed` | oracle/test | P3 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_fleet_probe_resume_token` | oracle/test | P3 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_fleet_restart_pending` | oracle/test | P3 | 424 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_fleet_restart_timeout` | oracle/test | P3 | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_gateway_launcher_refresh` | oracle/test | P3 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_gateway_restart_aborted` | oracle/test | P3 | 105 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_gateway_restart_fallback` | oracle/test | P3 | 120 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_handoff_backend_reap` | oracle/test | P3 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_handoff_exit` | oracle/test | P3 | 133 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_hangup_protection` | oracle/test | P3 | 238 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_head_moved_gate` | oracle/test | P3 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_interrupted_recovery` | oracle/test | P3 | 110 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_inventory` | oracle/test | P3 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_launchd_fleet_restart` | oracle/test | P3 | 655 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_launchd_restart_verification` | oracle/test | P3 | 324 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_launchd_unloaded_gateway` | oracle/test | P3 | 204 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_orphan_backend_reap` | oracle/test | P3 | 313 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_parked_branch_guard` | oracle/test | P3 | 613 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_receipt` | oracle/test | P3 | 397 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_receipt_endpoint` | oracle/test | P3 | 145 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_restart_recovery` | oracle/test | P3 | 462 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_secret_import_lock` | oracle/test | P3 | 119 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_self_lock` | oracle/test | P3 | 332 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_shim_fail_closed` | oracle/test | P3 | 210 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_shim_self_lock` | oracle/test | P3 | 306 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_skip_unchanged_editable_install` | oracle/test | P3 | 108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_stale_dashboard` | oracle/test | P3 | 922 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_stale_module_purge` | oracle/test | P3 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_stale_virtualenv` | oracle/test | P3 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_state_autorestore` | oracle/test | P3 | 213 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_upstream_prompt_noninteractive` | oracle/test | P3 | 124 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_venv_health` | oracle/test | P3 | 165 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_version_report` | oracle/test | P3 | 67 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_wedged_gateway` | oracle/test | P3 | 985 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_yes_flag` | oracle/test | P3 | 237 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_update_zip_fallback_guards` | oracle/test | P3 | 356 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_zip_release_preserve` | oracle/test | P3 | 56 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_update_zip_symlink_reject` | oracle/test | P3 | 137 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_urllib_security` | oracle/test | P3 | 513 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_venv_holder_classifier` | oracle/test | P3 | 70 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_venv_holder_windows_live` | oracle/test | P3 | 307 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_verify_core_dependencies` | oracle/test | P3 | 156 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_video_gen_picker` | oracle/test | P3 | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_voice_wrapper` | oracle/test | P3 | 498 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_oauth_dispatch` | oracle/test | P3 | 779 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_routers_tools_install_on_enable` | oracle/test | P3 | 147 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server` | oracle/test | P3 | 5,210 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_approvals_broadcast` | oracle/test | P3 | 226 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_server_config_offloop` | oracle/test | P3 | 318 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_server_cron_profiles` | oracle/test | P3 | 1,189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_executor_isolation` | oracle/test | P3 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_files` | oracle/test | P3 | 377 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_fs` | oracle/test | P3 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_gateway_topology` | oracle/test | P3 | 537 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_git` | oracle/test | P3 | 196 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_host_header` | oracle/test | P3 | 243 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_server_profile_unification` | oracle/test | P3 | 814 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_web_server_pty_idle_backoff` | oracle/test | P3 | 73 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_server_pty_reconnect` | oracle/test | P3 | 167 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_web_ui_build` | oracle/test | P3 | 429 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_cli.test_win_pty_bridge` | oracle/test | P3 | 251 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_windows_gateway_cold_start_desktop_lifecycle` | oracle/test | P3 | 130 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_windows_native_docs` | oracle/test | P3 | 22 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_windows_update_restart_reconciliation` | oracle/test | P3 | 151 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_worktree_command` | oracle/test | P3 | 147 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_worktree_gc` | oracle/test | P3 | 243 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_cli.test_xai_curated_models` | oracle/test | P3 | 56 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_94895_orphan_sweep_cross_backend` | oracle/test | P1 | 304 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_aux_usage_accounting` | oracle/test | P1 | 298 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_canonical_title_guard` | oracle/test | P1 | 71 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_composite_carrier_rewind` | oracle/test | P1 | 381 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_empty_sweep_archived_transcript_95868` | oracle/test | P1 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_get_messages_include_compacted` | oracle/test | P1 | 251 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_isolation_marker_env` | oracle/test | P1 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_live_db_guard_ancestry` | oracle/test | P1 | 160 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_live_db_isolation_guard` | oracle/test | P1 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_named_profile_session_db` | oracle/test | P1 | 211 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_never_active_keyed_prune` | oracle/test | P1 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_orphan_gateway_session_repair` | oracle/test | P1 | 310 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_reasoning_roundtrip` | oracle/test | P1 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_replace_messages_archive_siblings` | oracle/test | P1 | 260 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_session_hidden` | oracle/test | P1 | 44 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.hermes_state.test_session_lifecycle_status` | oracle/test | P1 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.hermes_state.test_sweep_orphaned_sessions` | oracle/test | P1 | 173 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.honcho_plugin.test_async_memory` | oracle/test | oracle | 603 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.honcho_plugin.test_auth_recovery` | oracle/test | oracle | 1,166 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.honcho_plugin.test_client` | oracle/test | oracle | 779 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.honcho_plugin.test_client_identity_isolation` | oracle/test | oracle | 314 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.honcho_plugin.test_oauth` | oracle/test | oracle | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.honcho_plugin.test_save_messages` | oracle/test | oracle | 104 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.monitoring.test_otlp_exporter` | oracle/test | oracle | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.openviking_plugin.test_openviking` | oracle/test | oracle | 1,468 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.perf_guards.test_pattern_b_scaling` | oracle/test | oracle | 213 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.browser.test_browser_provider_plugins` | oracle/test | P4 | 297 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.image_gen.test_krea_provider` | oracle/test | P4 | 705 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.image_gen.test_openai_codex_provider` | oracle/test | P4 | 467 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.image_gen.test_openrouter_compat_provider` | oracle/test | P4 | 787 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.image_gen.test_xai_provider` | oracle/test | P4 | 539 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_discovery_sources` | oracle/test | P4 | 221 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_hindsight_local_runtime_hint` | oracle/test | P4 | 56 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.memory.test_hindsight_provider` | oracle/test | P4 | 1,645 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.memory.test_hindsight_templates` | oracle/test | P4 | 260 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_holographic_shutdown_closes_db` | oracle/test | P4 | 130 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_honcho_cli_peers` | oracle/test | P4 | 125 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_mem0_backend` | oracle/test | P4 | 680 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.memory.test_mem0_backend_integration` | oracle/test | P4 | 131 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_mem0_setup` | oracle/test | P4 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_openviking_provider` | oracle/test | P4 | 1,923 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.memory.test_retaindb_provider` | oracle/test | P4 | 241 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.model_providers.test_commandcode_profile` | oracle/test | P4 | 367 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.model_providers.test_custom_profile` | oracle/test | P4 | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.model_providers.test_kimi_profile` | oracle/test | P4 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.model_providers.test_nous_profile` | oracle/test | P4 | 139 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.model_providers.test_ollama_cloud_profile` | oracle/test | P4 | 234 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.model_providers.test_opencode_go_profile` | oracle/test | P4 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.model_providers.test_zai_profile` | oracle/test | P4 | 224 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_a2a_schema_registration` | oracle/test | P4 | 54 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.test_a2a_tools_gate` | oracle/test | P4 | 65 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_chronos_cron` | oracle/test | P4 | 239 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_kanban_board_lifecycle_api` | oracle/test | P4 | 87 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_kanban_dashboard_plugin` | oracle/test | P4 | 1,232 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.test_kanban_dashboard_task_updated_hook` | oracle/test | P4 | 100 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_kanban_ws_idle_disconnect` | oracle/test | P4 | 226 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.test_langfuse_plugin` | oracle/test | P4 | 2,389 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.test_teams_pipeline_meetings` | oracle/test | P4 | 77 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.plugins.test_teams_pipeline_plugin` | oracle/test | P4 | 692 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.plugins.video_gen.test_fal_plugin` | oracle/test | P4 | 629 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.providers.test_e2e_wiring` | oracle/test | P2 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.providers.test_entry_point_discovery` | oracle/test | P2 | 225 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.providers.test_fetch_models_base_url` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.providers.test_meta_ai_profile` | oracle/test | P2 | 61 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.providers.test_plugin_discovery` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.providers.test_provider_profiles` | oracle/test | P2 | 313 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.providers.test_transport_parity` | oracle/test | P2 | 185 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.relay.test_relay_format_hints` | oracle/test | oracle | 308 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.relay.test_relay_inchannel_continuable` | oracle/test | oracle | 187 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.relay.test_relay_prompt_ack_stream_isolation` | oracle/test | oracle | 195 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_413_compression` | oracle/test | P2 | 1,214 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_69078_image_corrupt_recovery` | oracle/test | P2 | 465 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_81641_text_turn_incremental_persistence` | oracle/test | P2 | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_92450_outer_error_retry_bound` | oracle/test | P2 | 205 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_agent_guardrails` | oracle/test | P2 | 333 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_anthropic_prompt_cache_policy` | oracle/test | P2 | 1,055 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_async_httpx_del_neuter` | oracle/test | P2 | 383 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_background_review` | oracle/test | P2 | 864 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_background_review_cost_controls` | oracle/test | P2 | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_background_review_input_budget` | oracle/test | P2 | 239 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_background_review_toolset_restriction` | oracle/test | P2 | 267 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_codex_app_server_compaction` | oracle/test | P2 | 323 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_codex_sdk_transform_bypass` | oracle/test | P2 | 157 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_compress_context_fallback_shim` | oracle/test | P2 | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_compression_boundary_hook` | oracle/test | P2 | 327 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_compression_budget_rearm` | oracle/test | P2 | 223 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_compression_budget_refund` | oracle/test | P2 | 280 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_compression_closed_adoption` | oracle/test | P2 | 242 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_compression_persistence` | oracle/test | P2 | 533 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_continuation_ceiling_wedge` | oracle/test | P2 | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_continuation_repetition_guard` | oracle/test | P2 | 99 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_corruption_recovery_guidance` | oracle/test | P2 | 52 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_create_openai_client_reuse` | oracle/test | P2 | 347 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_cross_process_turn_lease` | oracle/test | P2 | 637 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_env_credential_turn_refresh` | oracle/test | P2 | 299 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_fallback_api_mode_preservation` | oracle/test | P2 | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_file_mutation_verifier` | oracle/test | P2 | 382 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_identity_flush` | oracle/test | P2 | 286 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_image_rejection_fallback` | oracle/test | P2 | 299 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_image_shrink_recovery` | oracle/test | P2 | 561 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_in_place_compaction` | oracle/test | P2 | 438 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_infinite_compaction_loop` | oracle/test | P2 | 264 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_interpreter_shutdown_turn_exit` | oracle/test | P2 | 194 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_interrupt_propagation` | oracle/test | P2 | 306 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_memory_provider_init` | oracle/test | P2 | 172 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_message_sequence_repair` | oracle/test | P2 | 1,390 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_moa_loop_mode` | oracle/test | P2 | 1,338 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_native_compaction` | oracle/test | P2 | 715 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_native_compaction_summary_retention` | oracle/test | P2 | 394 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_opencode_free_client_headers` | oracle/test | P2 | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_partial_stream_finish_reason` | oracle/test | P2 | 791 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_plugin_stream_hooks` | oracle/test | P2 | 371 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_pre_compress_memory_context` | oracle/test | P2 | 235 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_primary_runtime_restore` | oracle/test | P2 | 868 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_provider_attribution_headers` | oracle/test | P2 | 283 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_provider_fallback` | oracle/test | P2 | 504 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_reasoning_echo_resolver_e2e` | oracle/test | P2 | 108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_retry_status_buffer` | oracle/test | P2 | 236 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_review_prompt_class_first` | oracle/test | P2 | 191 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_run_agent` | oracle/test | P2 | 7,108 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_run_agent_codex_responses` | oracle/test | P2 | 2,409 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_sequential_tool_timeout` | oracle/test | P2 | 349 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_steer` | oracle/test | P2 | 851 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_stream_interrupt_retry` | oracle/test | P2 | 325 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_stream_stale_circuit_breaker` | oracle/test | P2 | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_streaming` | oracle/test | P2 | 1,767 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_summarize_api_error` | oracle/test | P2 | 98 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_switch_model_fallback_prune` | oracle/test | P2 | 109 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_thinking_only_sanitizer` | oracle/test | P2 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_thinking_prefill_trailing_turn` | oracle/test | P2 | 146 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_token_persistence_non_cli` | oracle/test | P2 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_tool_activity_heartbeat` | oracle/test | P2 | 270 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_tool_batch_segmentation` | oracle/test | P2 | 741 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_tool_call_guardrail_runtime` | oracle/test | P2 | 425 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.run_agent.test_tool_call_incremental_persistence` | oracle/test | P2 | 901 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.run_agent.test_turn_completion_explainer` | oracle/test | P2 | 428 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.scripts.test_contributor_map` | oracle/test | oracle | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.scripts.test_windows_footguns_full_repo_scan` | oracle/test | oracle | 41 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.secret_sources.test_error_remediation` | oracle/test | oracle | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.secret_sources.test_secret_source_registry` | oracle/test | oracle | 363 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_authoring_standards` | oracle/test | oracle | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_box_skill` | oracle/test | oracle | 76 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_comfyui_skill` | oracle/test | oracle | 132 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_competitor_news_monitor_skill` | oracle/test | oracle | 111 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_decision_questionnaire_skill` | oracle/test | oracle | 62 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_email_inbox_triage_skill` | oracle/test | oracle | 89 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_github_issue_to_pr_skill` | oracle/test | oracle | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_google_workspace_daily_brief_reference` | oracle/test | oracle | 59 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_har_derived_api_client_skill` | oracle/test | oracle | 180 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_hermes_agent_skill` | oracle/test | oracle | 69 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_meeting_action_items_skill` | oracle/test | oracle | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_merge_reconciler_skill` | oracle/test | oracle | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_office_document_skills` | oracle/test | oracle | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_openclaw_migration` | oracle/test | oracle | 750 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_product_price_monitor_skill` | oracle/test | oracle | 117 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_publish_site_skill` | oracle/test | oracle | 143 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_sdlc_review_skill` | oracle/test | oracle | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_setup_wizard_generator_skill` | oracle/test | oracle | 87 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.skills.test_social_media_content_calendar_skill` | oracle/test | oracle | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.skills.test_weekly_review_planning_skill` | oracle/test | oracle | 119 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.state.test_compression_lineage_guard` | oracle/test | oracle | 325 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.state.test_dedupe_migration_contention` | oracle/test | oracle | 120 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.state.test_fts_rebuild_admission` | oracle/test | oracle | 226 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.state.test_fts_runtime_rebuild` | oracle/test | oracle | 665 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.state.test_no_locked_readers_gate` | oracle/test | oracle | 237 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.state.test_session_git_metadata_generation` | oracle/test | oracle | 257 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.state.test_session_turn_lease` | oracle/test | oracle | 669 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_89315_replace_ownership_guard` | oracle/test | oracle | 393 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_atomic_replace_symlinks` | oracle/test | oracle | 599 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_batch_runner_checkpoint` | oracle/test | oracle | 290 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_batch_runner_discard_resume` | oracle/test | oracle | 175 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_batch_runner_exit_code` | oracle/test | oracle | 64 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_cli_quiet_stdout_leak` | oracle/test | oracle | 105 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_code_skew` | oracle/test | oracle | 146 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_compaction_tool_refresh` | oracle/test | oracle | 105 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_compression_watermark_commit` | oracle/test | oracle | 340 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_cron_manage_profile_scope` | oracle/test | oracle | 76 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_desktop_update_shim_progress` | oracle/test | oracle | 199 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_desktop_update_windows_pipe_drain` | oracle/test | oracle | 215 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_desktop_update_windows_progress` | oracle/test | oracle | 134 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_desktop_update_windows_python_handoff` | oracle/test | oracle | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_desktop_update_windows_timestamp` | oracle/test | oracle | 34 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_display_hermes_home` | oracle/test | oracle | 73 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_engines_satisfiable` | oracle/test | oracle | 297 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_estop` | oracle/test | oracle | 378 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_get_tool_definitions_cache_isolation` | oracle/test | oracle | 110 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_gitlock` | oracle/test | oracle | 139 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_guest_durability_barriers` | oracle/test | oracle | 68 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_hermes_bootstrap` | oracle/test | oracle | 367 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_hermes_constants` | oracle/test | oracle | 1,154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_hermes_logging` | oracle/test | oracle | 680 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_hermes_state` | oracle/test | oracle | 5,352 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_hermes_state_compression_busy_retry` | oracle/test | oracle | 105 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_hermes_state_compression_locks` | oracle/test | oracle | 224 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_hermetic_side_effect_guards` | oracle/test | oracle | 69 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_honcho_client_config` | oracle/test | oracle | 206 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_honcho_startup_fail_open` | oracle/test | oracle | 550 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_ps1_browser_install` | oracle/test | oracle | 72 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_ps1_managed_node_swap` | oracle/test | oracle | 79 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_ps1_resolver_strictmode` | oracle/test | oracle | 71 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_ps1_uv_install_fallback` | oracle/test | oracle | 130 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_ps1_venv_process_tree` | oracle/test | oracle | 182 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_ps1_venv_recreate_safety` | oracle/test | oracle | 75 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_ps1_venv_rename_abort` | oracle/test | oracle | 64 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_ps1_venv_transaction_boundary` | oracle/test | oracle | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_scripts_computer_use` | oracle/test | oracle | 76 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_sh_browser_install` | oracle/test | oracle | 249 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_sh_node_deps_failure` | oracle/test | oracle | 145 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_sh_node_npm_check` | oracle/test | oracle | 42 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_install_sh_uv_lock_config` | oracle/test | oracle | 179 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_install_unmerged_index` | oracle/test | oracle | 191 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_journal_mode_config` | oracle/test | oracle | 330 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_journal_mode_upgrade_warning` | oracle/test | oracle | 358 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_lazy_secrets_dispatch` | oracle/test | oracle | 236 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_lazy_secrets_import` | oracle/test | oracle | 112 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_managed_runtime_resolution` | oracle/test | oracle | 230 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_mcp_serve` | oracle/test | oracle | 1,426 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_message_reactions` | oracle/test | oracle | 183 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_moa_prepared_request_leak_78382` | oracle/test | oracle | 67 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_os_marker_gating` | oracle/test | oracle | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_output_cap_parsing` | oracle/test | oracle | 193 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_packaging_build_guard` | oracle/test | oracle | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_packaging_metadata` | oracle/test | oracle | 380 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_plugin_skills` | oracle/test | oracle | 510 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_plugin_storage` | oracle/test | oracle | 65 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_plugins_manage_profile_scope` | oracle/test | oracle | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_pty_keepalive_ws` | oracle/test | oracle | 122 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_pty_session` | oracle/test | oracle | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_redaction_registry` | oracle/test | oracle | 251 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_resource_limits` | oracle/test | oracle | 349 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_run_tests_parallel` | oracle/test | oracle | 462 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_session_db_context_manager` | oracle/test | oracle | 100 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_session_db_read_conn_pool` | oracle/test | oracle | 386 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_session_db_read_path_split` | oracle/test | oracle | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_session_delete_profile_isolation` | oracle/test | oracle | 51 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_session_skill_previews` | oracle/test | oracle | 214 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_state_db_malformed_repair` | oracle/test | oracle | 842 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_notadb_fail_closed` | oracle/test | oracle | 77 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_repair_live_writer_guard` | oracle/test | oracle | 93 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_repair_loop_cap` | oracle/test | oracle | 163 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_repair_loop_mtime` | oracle/test | oracle | 784 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_repair_non_destructive` | oracle/test | oracle | 877 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_stats` | oracle/test | oracle | 259 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_db_write_durability` | oracle/test | oracle | 169 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_state_synchronous_pragma` | oracle/test | oracle | 247 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_toolsets` | oracle/test | oracle | 358 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_transform_api_error_classification_hook` | oracle/test | oracle | 216 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_tui_gateway_event_replay` | oracle/test | oracle | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_tui_gateway_queue_on_busy` | oracle/test | oracle | 782 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_tui_gateway_server` | oracle/test | oracle | 21,454 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_tui_gateway_ws` | oracle/test | oracle | 274 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_utils_atomic_roundtrip_yaml_save` | oracle/test | oracle | 276 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_wal_checkpoint_strategy` | oracle/test | oracle | 223 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_web_server` | oracle/test | oracle | 340 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.test_windows_subprocess_no_window_flags` | oracle/test | oracle | 430 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.test_ws_keepalive_config` | oracle/test | oracle | 92 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.conftest` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_a2a_reason_roundtrip` | oracle/test | P2 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_allowlist_quoted_metachars` | oracle/test | P2 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_annotate_preview_tool` | oracle/test | P2 | 88 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_apply_layout_tool` | oracle/test | P2 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_approval` | oracle/test | P2 | 1,900 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_approval_hook_session_id` | oracle/test | P2 | 92 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_approval_outcome_parity` | oracle/test | P2 | 77 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_approval_timeout_overflow` | oracle/test | P2 | 138 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_approval_windows` | oracle/test | P2 | 110 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_approved_command_clean_slate` | oracle/test | P2 | 239 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_async_delegation` | oracle/test | P2 | 883 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_base_environment` | oracle/test | P2 | 472 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_binary_document_write_guard` | oracle/test | P2 | 188 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_bot_dm_payload_cache` | oracle/test | P2 | 74 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_failure_reasons` | oracle/test | P2 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_mode_dm` | oracle/test | P2 | 640 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_mode_probe` | oracle/test | P2 | 280 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_relay` | oracle/test | P2 | 540 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_relay_windows_paths` | oracle/test | P2 | 163 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_retry_policy` | oracle/test | P2 | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_bot_turn_lock` | oracle/test | P2 | 343 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_cdp_tool` | oracle/test | P2 | 657 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_chromium_autoinstall` | oracle/test | P2 | 109 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_cloud_provider_cache` | oracle/test | P2 | 271 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_console` | oracle/test | P2 | 477 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_content_none_guard` | oracle/test | P2 | 69 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_extension_router` | oracle/test | P2 | 467 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_extension_router_wiring` | oracle/test | P2 | 96 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_hardening` | oracle/test | P2 | 335 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_homebrew_paths` | oracle/test | P2 | 580 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_npx_warmup` | oracle/test | P2 | 320 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_open_timeout` | oracle/test | P2 | 173 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_orphan_reaper` | oracle/test | P2 | 566 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_real_profile` | oracle/test | P2 | 1,054 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_real_profile_pin` | oracle/test | P2 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_browser_secret_exfil` | oracle/test | P2 | 310 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_snapshot_threshold` | oracle/test | P2 | 219 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_suspect_recycle` | oracle/test | P2 | 266 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_browser_use_cli` | oracle/test | P2 | 1,094 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_budget_config` | oracle/test | P2 | 240 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_build_subprocess_env` | oracle/test | P2 | 142 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_checkpoint_manager` | oracle/test | P2 | 1,314 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_clarify_gateway` | oracle/test | P2 | 462 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_clarify_tool` | oracle/test | P2 | 678 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_cli_approval_exec_ask_leak` | oracle/test | P2 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_clipboard` | oracle/test | P2 | 565 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_close_preview_tool` | oracle/test | P2 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_code_execution` | oracle/test | P2 | 925 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_code_execution_modes` | oracle/test | P2 | 625 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_code_execution_windows_env` | oracle/test | P2 | 656 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_code_kernel` | oracle/test | P2 | 404 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_code_kernel_remote` | oracle/test | P2 | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_computer_use` | oracle/test | P2 | 2,658 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_computer_use_cua_0_10_permissions` | oracle/test | P2 | 357 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_cua_0_9` | oracle/test | P2 | 390 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_cua_backend_linux` | oracle/test | P2 | 144 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_cua_macos_identity` | oracle/test | P2 | 178 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_computer_use_display_count_guard` | oracle/test | P2 | 60 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_empty_discovery_diagnosis` | oracle/test | P2 | 121 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_fullscreen_capture` | oracle/test | P2 | 240 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_computer_use_input_target_guard` | oracle/test | P2 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_computer_use_placeholder_ids` | oracle/test | P2 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_computer_use_zero_bounds` | oracle/test | P2 | 54 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_credential_files` | oracle/test | P2 | 627 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_cronjob_run_immediate` | oracle/test | P2 | 293 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_cronjob_tools` | oracle/test | P2 | 772 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_cross_profile_guard` | oracle/test | P2 | 229 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_deferral_fixes` | oracle/test | P2 | 330 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_delegate` | oracle/test | P2 | 2,026 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_delegate_batch_validation` | oracle/test | P2 | 186 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_delegate_control_actions` | oracle/test | P2 | 710 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_delegate_cron_sync_fallback` | oracle/test | P2 | 179 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_delegate_output_schema` | oracle/test | P2 | 367 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_delegate_request_overrides` | oracle/test | P2 | 256 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_delegation_live_log` | oracle/test | P2 | 336 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_desktop_tools_diet` | oracle/test | P2 | 113 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_docker_environment` | oracle/test | P2 | 1,648 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_docker_session_isolation` | oracle/test | P2 | 327 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_drive_preview_tool` | oracle/test | P2 | 128 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_file_operations` | oracle/test | P2 | 900 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_file_read_guards` | oracle/test | P2 | 857 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_file_tools` | oracle/test | P2 | 1,046 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_file_tools_live` | oracle/test | P2 | 276 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_file_write_safety` | oracle/test | P2 | 691 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_file_write_surrogate_roundtrip` | oracle/test | P2 | 220 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_find_shell` | oracle/test | P2 | 274 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_fuzzy_match` | oracle/test | P2 | 717 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_generation_source_confinement` | oracle/test | P2 | 132 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_hardline_blocklist` | oracle/test | P2 | 809 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_image_generate_schema` | oracle/test | P2 | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_image_generation` | oracle/test | P2 | 651 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_image_generation_image_to_image` | oracle/test | P2 | 296 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_image_generation_interrupt` | oracle/test | P2 | 82 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_image_source` | oracle/test | P2 | 399 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_interrupted_command_cwd` | oracle/test | P2 | 205 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_kanban_tools` | oracle/test | P2 | 1,136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_lazy_deps` | oracle/test | P2 | 485 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_lazy_deps_durable_target` | oracle/test | P2 | 295 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_local_env_blocklist` | oracle/test | P2 | 1,547 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_local_env_windows_msys` | oracle/test | P2 | 334 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_local_setsid_descendant_sweep` | oracle/test | P2 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_local_temp_dir` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_macos_protected_search` | oracle/test | P2 | 211 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_managed_media_gateways` | oracle/test | P2 | 343 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_capability_gating` | oracle/test | P2 | 298 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_cimd` | oracle/test | P2 | 680 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_client_cert` | oracle/test | P2 | 339 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_dashboard_oauth` | oracle/test | P2 | 116 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_dynamic_discovery` | oracle/test | P2 | 134 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_elicitation` | oracle/test | P2 | 332 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_failure_classification` | oracle/test | P2 | 267 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_initial_connect_shutdown` | oracle/test | P2 | 286 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_oauth` | oracle/test | P2 | 1,114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_oauth_bidirectional` | oracle/test | P2 | 319 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_oauth_cold_load_expiry` | oracle/test | P2 | 478 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_oauth_manager` | oracle/test | P2 | 490 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_oauth_user_agent` | oracle/test | P2 | 177 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_parked_self_probe` | oracle/test | P2 | 138 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_protocol_negotiation` | oracle/test | P2 | 144 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_reconnect_log_hygiene` | oracle/test | P2 | 176 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_reconnect_retry_reset` | oracle/test | P2 | 197 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_result_size_limit` | oracle/test | P2 | 69 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_schema_cache_ttl` | oracle/test | P2 | 51 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_server_log_notifications` | oracle/test | P2 | 89 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_stdio_children_dead` | oracle/test | P2 | 94 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_stdio_fastfail_reconnect` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_mcp_streamable_http_arity` | oracle/test | P2 | 214 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_structured_content` | oracle/test | P2 | 217 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_timeout_resolution` | oracle/test | P2 | 52 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_mcp_tool` | oracle/test | P2 | 3,014 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_memory_tool` | oracle/test | P2 | 708 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_microsoft_graph_client` | oracle/test | P2 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_modal_sandbox_fixes` | oracle/test | P2 | 448 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_notify_on_complete` | oracle/test | P2 | 443 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_oneshot_completion_linger` | oracle/test | P2 | 385 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_open_preview_tool` | oracle/test | P2 | 37 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_patch_already_applied` | oracle/test | P2 | 166 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_patch_v4a_gate` | oracle/test | P2 | 85 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_plugin_guard` | oracle/test | P2 | 283 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_pre_transcription_hook` | oracle/test | P2 | 631 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_process_registry` | oracle/test | P2 | 2,415 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_process_registry_write_stdin_surrogates` | oracle/test | P2 | 54 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_process_schema_diet` | oracle/test | P2 | 41 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_react_to_message_tool` | oracle/test | P2 | 22 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_binary_type_disclosure` | oracle/test | P2 | 90 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_extract` | oracle/test | P2 | 911 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_file_schema_gating` | oracle/test | P2 | 220 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_file_utf8_binary_regression` | oracle/test | P2 | 129 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_read_past_eof_note` | oracle/test | P2 | 44 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_preview_tool` | oracle/test | P2 | 68 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_shell_line_clamp` | oracle/test | P2 | 126 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_special_file_guard` | oracle/test | P2 | 76 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_unicode_filename_retry` | oracle/test | P2 | 73 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_read_window_tool` | oracle/test | P2 | 50 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_registry` | oracle/test | P2 | 705 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_restored_delegation_ownership` | oracle/test | P2 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_rollback_all_directories` | oracle/test | P2 | 70 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_safe_getcwd_permission_error` | oracle/test | P2 | 91 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_search_hidden_dirs` | oracle/test | P2 | 213 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_search_zero_match_and_multipath` | oracle/test | P2 | 181 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_self_repo_guard` | oracle/test | P2 | 381 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_send_message_cross_loop` | oracle/test | P2 | 201 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_send_message_plugin_extensibility` | oracle/test | P2 | 272 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_send_message_target_parse` | oracle/test | P2 | 312 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_send_message_telegram_proxy` | oracle/test | P2 | 162 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_send_message_tool` | oracle/test | P2 | 1,867 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_session_cwd_store` | oracle/test | P2 | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_session_search` | oracle/test | P2 | 1,146 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_setup_mcp_tool` | oracle/test | P2 | 83 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_shared_container_task_id` | oracle/test | P2 | 311 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_single_query_approval_mode` | oracle/test | P2 | 364 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_singularity_persistent_overlay` | oracle/test | P2 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skill_bundle_provenance` | oracle/test | P2 | 604 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_env_passthrough` | oracle/test | P2 | 139 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_improvements` | oracle/test | P2 | 335 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_ledger` | oracle/test | P2 | 367 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_linter` | oracle/test | P2 | 189 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_manage_batch` | oracle/test | P2 | 259 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_manage_schema_diet` | oracle/test | P2 | 72 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skill_manager_tool` | oracle/test | P2 | 1,160 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skill_usage` | oracle/test | P2 | 558 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skill_view_path_check` | oracle/test | P2 | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skillevaluator_scan` | oracle/test | P2 | 293 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skills_guard` | oracle/test | P2 | 499 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skills_guard_agent_config` | oracle/test | P2 | 202 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_skills_hub` | oracle/test | P2 | 1,987 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skills_hub_clawhub` | oracle/test | P2 | 680 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_skills_sync` | oracle/test | P2 | 1,004 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_smart_approval_policy` | oracle/test | P2 | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_snapshot_session_id_leak` | oracle/test | P2 | 109 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_spill_safety` | oracle/test | P2 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_ssh_environment` | oracle/test | P2 | 252 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_stage2_hook_api_server_keygen` | oracle/test | P2 | 290 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_startup_latency_regressions` | oracle/test | P2 | 211 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_strict_provider_selection` | oracle/test | P2 | 360 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_subagent_sudo_prompt` | oracle/test | P2 | 139 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_subagent_worktree` | oracle/test | P2 | 408 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_subprocess_stdin_guard` | oracle/test | P2 | 84 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_telegram_send_message_caption` | oracle/test | P2 | 107 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_terminal_error_redaction` | oracle/test | P2 | 154 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_terminal_heredoc_background_guard` | oracle/test | P2 | 268 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_terminal_hints` | oracle/test | P2 | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_terminal_self_repo_guard` | oracle/test | P2 | 136 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_terminal_signal_exit` | oracle/test | P2 | 95 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_terminal_task_cwd` | oracle/test | P2 | 250 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_terminal_tool_exception_redaction` | oracle/test | P2 | 44 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_threat_patterns` | oracle/test | P2 | 302 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tip_tool` | oracle/test | P2 | 87 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tirith_security` | oracle/test | P2 | 722 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_todo_nested` | oracle/test | P2 | 167 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_todo_schema_diet` | oracle/test | P2 | 50 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_todo_tool` | oracle/test | P2 | 212 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_todo_tool_type_coercion` | oracle/test | P2 | 83 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tool_result_storage` | oracle/test | P2 | 501 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tool_search` | oracle/test | P2 | 698 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tool_search_multiquery` | oracle/test | P2 | 553 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tour_tool` | oracle/test | P2 | 80 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_transcription` | oracle/test | P2 | 291 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_transcription_tools` | oracle/test | P2 | 1,350 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tts_long_form_chunking` | oracle/test | P2 | 150 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tts_macos_output` | oracle/test | P2 | 86 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_tts_max_text_length` | oracle/test | P2 | 148 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tts_openai_config` | oracle/test | P2 | 111 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tts_streaming` | oracle/test | P2 | 960 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_tts_xai_speech_tags` | oracle/test | P2 | 307 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_unicode_tag_strip` | oracle/test | P2 | 55 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_utf16_read` | oracle/test | P2 | 106 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_vercel_sandbox_environment` | oracle/test | P2 | 623 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_video_analyze` | oracle/test | P2 | 289 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_video_generate_schema` | oracle/test | P2 | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_video_generation_dispatch` | oracle/test | P2 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_video_generation_dynamic_schema` | oracle/test | P2 | 171 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_video_generation_tool_surface_matrix` | oracle/test | P2 | 304 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_vision_native_fast_path` | oracle/test | P2 | 435 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_vision_scale_disclosure` | oracle/test | P2 | 256 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_vision_tools` | oracle/test | P2 | 1,123 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_voice_cli_integration` | oracle/test | P2 | 683 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_voice_client_config` | oracle/test | P2 | 191 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_voice_mode` | oracle/test | P2 | 1,602 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_wake_word` | oracle/test | P2 | 783 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_watch_patterns` | oracle/test | P2 | 469 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_web_keyless_fallback` | oracle/test | P2 | 545 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_web_keyless_rescue` | oracle/test | P2 | 247 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_web_providers` | oracle/test | P2 | 531 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_web_providers_searxng` | oracle/test | P2 | 255 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_web_result_cache` | oracle/test | P2 | 338 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_web_tools_config` | oracle/test | P2 | 821 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_web_tools_tavily` | oracle/test | P2 | 313 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_web_tools_truncate` | oracle/test | P2 | 111 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_windows_agent_loop_papercuts` | oracle/test | P2 | 230 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_windows_native_support` | oracle/test | P2 | 1,164 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_working_diff` | oracle/test | P2 | 123 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_write_approval` | oracle/test | P2 | 295 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tools.test_x_search_tool` | oracle/test | P2 | 434 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tools.test_xai_http_credentials` | oracle/test | P2 | 184 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_94895_backend_heartbeat` | oracle/test | P5 | 171 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_attach_does_not_wait_for_agent` | oracle/test | P5 | 138 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_bot_relay_methods` | oracle/test | P5 | 149 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_change_watcher` | oracle/test | P5 | 264 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_composite_carrier_rewind` | oracle/test | P5 | 512 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_compression_config_hot_reload` | oracle/test | P5 | 235 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_cross_process_orphan_ownership` | oracle/test | P5 | 416 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_custom_provider_session_persistence` | oracle/test | P5 | 849 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_deferred_model_switch_confirm` | oracle/test | P5 | 215 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_diagnostics_share_nous` | oracle/test | P5 | 151 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_ephemeral_profile_override` | oracle/test | P5 | 158 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_failed_turn_retention` | oracle/test | P5 | 355 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_goal_command` | oracle/test | P5 | 469 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_gui_surface_toolsets` | oracle/test | P5 | 118 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_hud_surface_note` | oracle/test | P5 | 178 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_image_ref_message` | oracle/test | P5 | 78 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_kanban_notify_poller` | oracle/test | P5 | 362 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_loop_command` | oracle/test | P5 | 210 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_make_agent_personality_prompt` | oracle/test | P5 | 73 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_mcp_oauth_client_callback` | oracle/test | P5 | 231 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_mcp_profile_rpcs` | oracle/test | P5 | 248 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_personality_clobbers_system_prompt` | oracle/test | P5 | 162 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_ping_probe` | oracle/test | P5 | 31 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_plugins_manage_install` | oracle/test | P5 | 73 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_profiles_configure_model_guard` | oracle/test | P5 | 111 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_profiles_list_canonical_session` | oracle/test | P5 | 414 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_profiles_list_worker_session` | oracle/test | P5 | 102 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_profiles_ui_meta_cas` | oracle/test | P5 | 98 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_project_tree` | oracle/test | P5 | 659 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_projects_rpc` | oracle/test | P5 | 824 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_prompt_accept_logging` | oracle/test | P5 | 183 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_protocol` | oracle/test | P5 | 1,296 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_resume_live_lazy_session` | oracle/test | P5 | 78 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_serve_exit_flush` | oracle/test | P5 | 200 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_session_db_ownership_teardown` | oracle/test | P5 | 413 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_session_git_metadata_generation` | oracle/test | P5 | 72 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_session_hidden_rpc` | oracle/test | P5 | 71 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_session_profile_db` | oracle/test | P5 | 392 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_session_resume_db_ownership` | oracle/test | P5 | 390 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_slash_fuzzy` | oracle/test | P5 | 120 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_slash_worker_mcp_discovery` | oracle/test | P5 | 114 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_slash_worker_profile_home` | oracle/test | P5 | 38 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_stale_provider_resume_live` | oracle/test | P5 | 207 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_startup_orphan_sweep` | oracle/test | P5 | 294 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_stranded_session_adoption` | oracle/test | P5 | 423 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_todo_state_events` | oracle/test | P5 | 100 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_tour_bridge_fail_fast` | oracle/test | P5 | 101 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
| `tests.tui_gateway.test_undo_command` | oracle/test | P5 | 112 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tests.tui_gateway.test_ws_keepalive` | oracle/test | P5 | 63 | ⬜ missing | Read the upstream test; add the matching Rust parity coverage and evidence. |
...
| `tools.annotate_preview_tool` | production | P2 | 139 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.ansi_strip` | production | P2 | 115 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.apply_layout_tool` | production | P2 | 71 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.approval` | production | P2 | 5,802 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.async_delegation` | production | P2 | 1,611 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.audio_container` | production | P2 | 97 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.binary_extensions` | production | P2 | 75 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tools.bot_failure_reasons` | production | P2 | 172 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.bot_mode_dm` | production | P2 | 765 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.bot_mode_probe` | production | P2 | 469 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.bot_relay` | production | P2 | 676 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.browser_use_cli` | production | P2 | 995 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.budget_config` | production | P2 | 174 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.checkpoint_manager` | production | P2 | 2,243 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.computer_use.__init__` | production | P2 | 47 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.computer_use.backend` | production | P2 | 224 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.computer_use.cua_backend` | production | P2 | 4,137 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.computer_use.doctor` | production | P2 | 904 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.computer_use.schema` | production | P2 | 249 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.computer_use.tool` | production | P2 | 1,696 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.credential_files` | production | P2 | 603 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `tools.cronjob_tools` | production | P2 | 2,112 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.delegate_tool` | production | P2 | 5,071 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.delegation_live_log` | production | P2 | 429 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.drive_preview_tool` | production | P2 | 219 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.env_probe` | production | P2 | 382 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tools.environments.base` | production | P2 | 1,550 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.environments.docker` | production | P2 | 2,084 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.environments.local` | production | P2 | 2,197 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.environments.singularity` | production | P2 | 273 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.environments.ssh` | production | P2 | 435 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.file_operations` | production | P2 | 3,578 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.file_state` | production | P2 | 332 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.file_tools` | production | P2 | 2,924 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.focus_pane_tool` | production | P2 | 63 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.fuzzy_match` | production | P2 | 1,187 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.hook_output_spill` | production | P2 | 241 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.image_generation_tool` | production | P2 | 2,154 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.image_source` | production | P2 | 476 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.interpreter_shutdown` | production | P2 | 56 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.interrupt` | production | P2 | 134 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.kanban_tools` | production | P2 | 2,480 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.lazy_deps` | production | P2 | 1,249 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.mcp_dashboard_oauth` | production | P2 | 145 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tools.open_preview_tool` | production | P2 | 88 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tools.patch_parser` | production | P2 | 737 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.path_security` | production | P2 | 43 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.plugin_guard` | production | P2 | 343 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.preview_tool` | production | P2 | 85 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.process_registry` | production | P2 | 3,371 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.project_tools` | production | P2 | 181 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.react_to_message_tool` | production | P2 | 193 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.read_extract` | production | P2 | 818 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.read_preview_tool` | production | P2 | 85 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.read_terminal_tool` | production | P2 | 87 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.read_window_tool` | production | P2 | 66 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.registry` | production | P2 | 1,335 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.schema_sanitizer` | production | P2 | 687 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.self_repo_guard` | production | P2 | 748 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.send_message_tool` | production | P2 | 2,354 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.session_search_tool` | production | P2 | 1,273 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.setup_mcp_tool` | production | P2 | 118 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.shell_heredoc` | production | P2 | 359 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.skills_guard` | production | P2 | 1,360 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.skills_hub` | production | P2 | 4,956 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.skills_sync` | production | P2 | 1,472 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.skills_tool` | production | P2 | 2,187 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.slash_confirm` | production | P2 | 167 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.spill_safety` | production | P2 | 118 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.subagent_worktree` | production | P2 | 352 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.terminal_hints` | production | P2 | 275 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.terminal_tool` | production | P2 | 4,213 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.thread_context` | production | P2 | 120 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.threat_patterns` | production | P2 | 289 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `tools.tip_tool` | production | P2 | 109 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.todo_tool` | production | P2 | 450 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `tools.tool_backend_helpers` | production | P2 | 431 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `tools.tool_output_limits` | production | P2 | 110 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
| `tools.tool_result_storage` | production | P2 | 450 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `tools.tool_search` | production | P2 | 1,320 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.tour_tool` | production | P2 | 198 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.transcription_tools` | production | P2 | 3,419 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.tts_tool` | production | P2 | 4,552 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.video_generation_tool` | production | P2 | 614 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.vision_tools` | production | P2 | 2,317 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.voice_client_config` | production | P2 | 337 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.wake_word` | production | P2 | 1,508 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.web_result_cache` | production | P2 | 429 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.web_tools` | production | P2 | 1,723 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tools.working_diff` | production | P2 | 131 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tools.x_search_tool` | production | P2 | 563 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tools.xai_http` | production | P2 | 389 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `toolsets` | production | P2 | 1,056 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `tui_gateway.compute_host` | production | P5 | 899 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.entry` | production | P5 | 516 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tui_gateway.event_replay` | production | P5 | 125 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.git_probe` | production | P5 | 202 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tui_gateway.mcp_oauth_sessions` | production | P5 | 429 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.mcp_rpc_helpers` | production | P5 | 74 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tui_gateway.methods_bot_relay` | production | P5 | 214 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_browser_control` | production | P5 | 382 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_complete` | production | P5 | 626 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_config` | production | P5 | 558 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_images` | production | P5 | 130 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_profiles` | production | P5 | 1,149 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_prompt` | production | P5 | 1,796 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_session` | production | P5 | 3,710 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.methods_tools` | production | P5 | 2,673 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.project_tree` | production | P5 | 793 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tui_gateway.server` | production | P5 | 17,691 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `tui_gateway.slash_fuzzy` | production | P5 | 91 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
...
| `tui_gateway.ws` | production | P5 | 596 | ⬜ missing | Read upstream module + tests; write tests first, implement, audit, build, test, ledger, commit. |
| `utils` | production | P1 | 924 | ✅ done | Maintain parity evidence; no remaining task in this row. |
