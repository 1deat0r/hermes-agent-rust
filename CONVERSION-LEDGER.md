...
**Current strict completion: 3.74% of all tracked upstream modules (145/3882).**
Production-only strict completion: **13.15%** (145/1103 production modules).
...
Inventory source: `/tmp/hermes-upstream-b9aa928` at `2026-09-14T14:33:34`.
...
| `agent.interrupt_compat` | P2 | 35 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `agent.monitoring.cron_health` | P2 | 201 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
...
| `agent.monitoring.otlp_exporter` | P2 | 272 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `agent.portal_tags` | P2 | 144 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
| `agent.secret_sources.bitwarden` | P2 | 1,048 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
...
| `hermes_cli.main` | P3 | 12,620 | Close the module-specific seam documented in `PLAN.md` and its Rust module doc. |
...
| `agent.monitoring.cron_health` | production | P2 | 201 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `agent.monitoring.otlp_exporter` | production | P2 | 272 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `agent.secret_sources.bitwarden` | production | P2 | 1,048 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `agent.secret_sources.registry` | production | P2 | 470 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `agent.ssl_guard` | production | P2 | 95 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `gateway.readiness` | production | P4 | 122 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.build_info` | production | P3 | 51 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.cli_output` | production | P3 | 77 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.dashboard_auth.base` | production | P3 | 306 | ✅ done | Maintain parity evidence; no remaining task in this row. |
| `hermes_cli.dashboard_auth.cookies` | production | P3 | 338 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.dashboard_auth.native_flow` | production | P3 | 297 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.dashboard_auth.registry` | production | P3 | 81 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.default_soul` | production | P3 | 76 | ✅ done | Maintain parity evidence; no remaining task in this row. |
...
| `hermes_cli.main` | production | P3 | 12,620 | 🟡 partial | Close every documented seam, add parity evidence, then promote to done. |
...
| `tools.open_preview_tool` | production | P2 | 92 | ✅ done | Maintain parity evidence; no remaining task in this row. |
