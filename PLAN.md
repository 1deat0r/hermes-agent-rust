...
- 2026-08-31 (session 4da): Twenty-five units across four crates, all red-first:
  ...
  hermes-agent` → 159 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,486 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 115 done / 18 partial / 3,749 tracked (**2.96%**) and 115 done /
  18 partial / 970 production (**10.61%**). Next: more small `tools/`/
