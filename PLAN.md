...
- 2026-08-31 (session 4da): Twenty-four units across four crates, all red-first:
  ...
  hermes-agent` → 150 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,477 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 115 done / 17 partial / 3,750 tracked (**2.96%**) and 115 done /
  17 partial / 971 production (**10.52%**). Next: more small `tools/`/
