...
Hermes-Agent-Rust/
  ...
  crates/
    ...
    hermes-providers/      # providers/base.py + providers/__init__.py + bundled profiles (Phase 2; base/registry plus Alibaba/Arcee profiles landed, CLI-version/opener and remaining loaders remain)
...
base/registry/Alibaba/Arcee profiles landed (2026-08-24).** The support wave below
...
first statically linked bundled profiles (`alibaba`, `arcee`). The provider surface
...
| providers/__init__.py bundled/user/legacy import execution | 🟡 | filesystem scan and explicit loader seam are implemented; statically linked Alibaba and Arcee are wired, remaining Rust plugin profiles/loaders remain pending |
