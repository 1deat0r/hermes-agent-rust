...
- 2026-08-31 (session 4da): Twenty-six units across four crates, all red-first:
  ...
  hermes-agent` → 172 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,499 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 115 done / 19 partial / 3,748 tracked (**2.96%**) and 115 done /
  19 partial / 969 production (**10.70%**). Next: more small `tools/`/
