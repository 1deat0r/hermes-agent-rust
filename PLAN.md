...
- 2026-08-31 (session 4da): Forty-four units across four crates, all red-first:
  ...
  Ledger: 132 done / 21 partial / 3,729 tracked (**3.40%**) and 132 done /
  21 partial / 950 production (**11.97%**). Next: more small `tools/`/
