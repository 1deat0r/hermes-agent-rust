...
Intentional credential-pool seam: the environment seeder, lower
  ...
  OpenAI Codex singleton seeders receive provider registry metadata, pool
...
planned dependency graph. Kimi's pure key-prefix endpoint routing, the Nous
  ...
  OAuth state-to-pool field copy, and OpenAI Codex nested-token field copy are
