...
- 2026-08-31 (session 4da): Thirty units across four crates, all red-first:
  ...
  hermes-agent` → 196 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,521 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 119 done / 19 partial / 3,744 tracked (**3.07%**) and 119 done /
  19 partial / 965 production (**10.79%**). Next: more small `tools/`/
