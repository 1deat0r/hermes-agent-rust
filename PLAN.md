...
- 2026-08-31 (session 4da): Thirty-four units across four crates, all red-first:
  ...
  hermes-agent` → 217 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,542 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 123 done / 19 partial / 3,740 tracked (**3.17%**) and 123 done /
  19 partial / 961 production (**11.15%**). Next: more small `tools/`/
