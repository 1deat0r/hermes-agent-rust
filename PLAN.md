...
- 2026-08-31 (session 4da): Forty-two units across four crates, all red-first:
  ...
  Ledger: 130 done / 21 partial / 3,731 tracked (**3.35%**) and 130 done /
  21 partial / 952 production (**11.79%**). Next: more small `tools/`/
