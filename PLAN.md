...
- 2026-08-31 (session 4da): Forty units across four crates, all red-first:
  ...
  hermes-agent` → 241 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,566 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 128 done / 21 partial / 3,733 tracked (**3.30%**) and 128 done /
  21 partial / 954 production (**11.60%**). Next: more small `tools/`/
