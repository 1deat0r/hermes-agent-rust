...
- 2026-08-31 (session 4da): Forty-one units across four crates, all red-first:
  ...
  hermes-agent` → 246 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,571 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 129 done / 21 partial / 3,732 tracked (**3.32%**) and 129 done /
  21 partial / 953 production (**11.69%**). Next: more small `tools/`/
