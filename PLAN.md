...
- 2026-08-31 (session 4da): Seventeen units across four crates, all red-first:
  ...
  hermes-agent` → 111 new tests green; `cargo clippy -p hermes-gateway -p hermes-cli -p
  ...
  passed 1,438 tests with 6 intentional ignores (the new one is
  skill_provenance's `ignore` doc example); `git diff --check` clean.
  Ledger: 110 done / 15 partial / 3,757 tracked (**2.83%**) and 110 done /
  15 partial / 978 production (**9.97%**). Next: more small `tools/`/
