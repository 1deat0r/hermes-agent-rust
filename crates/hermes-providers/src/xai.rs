...
//!
//! PARITY: `plugins/model-providers/xai/__init__.py` @ 5d59366.
...
pub(crate) fn profile() -> ProviderProfile {
    ...
    // PARITY: upstream imports hermes_cli.__version__ (0.21.3 at 5d59366).
    ...
    profile
        .default_headers
        .insert("User-Agent".into(), "Hermes-Agent/0.21.3".into());
    profile
}
