# Archived HANDOFF history (pin b9aa928 — superseded by 5d59366, 2026-09-16)
> Moved per doc-efficiency r2 (board-gated). Forward-only; board cites to this
> file keep working at this stable path. Current state lives in HANDOFF.md.
